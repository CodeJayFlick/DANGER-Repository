...
def algorithm(cities):
    ...
    for i_start, start in enumerate(cities):
        ...
        # Call to get_closest function (or newly added helper function)
        ...
        # New helper function call within the loop
        helper_value = calculate_something(length, order)
...
# New helper function
def calculate_something(length, order):
    # Some calculation logic
    return length + len(order)
