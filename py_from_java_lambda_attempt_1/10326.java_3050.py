...
class NoSuchElementException(Exception):
    pass
```
Note that I had to create a separate `NoSuchElementException` class in Python, as there is no built-in equivalent to Java's `java.util.NoSuchElementException`.