...
Note that Python does not have a direct equivalent to Java's `final` keyword. In this translation, I've omitted the `final` keywords as they are not necessary in Python.