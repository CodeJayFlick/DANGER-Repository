...
Please note that Python does not have a direct equivalent to Java's unsigned division and modulo operations. The `//` operator performs integer division, which is the same as floor division in Python.