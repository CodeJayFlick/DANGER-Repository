...
Note: This translation assumes that `SystemUtilities` is a separate class or module with methods like `is_in_testing_mode()`. You would need to implement this class/module in Python as well.