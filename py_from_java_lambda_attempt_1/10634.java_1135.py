...
Please note that this is a direct translation of the given Java code into equivalent Python. It might not be perfect, as some parts may need to be adjusted according to your specific requirements or constraints in your project.