...
Note that Python does not have direct equivalent of Java's `Class<?>[]` and `ObjectStorage`. I replaced them with a list (`[str]`) for the fields, and used the built-in string methods to handle storing and retrieving strings.