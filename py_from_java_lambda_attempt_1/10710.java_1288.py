...
Please note that Python does not have a direct equivalent to Java's `ImageIcon` and `JOptionPane`. The above code uses the PIL library for image processing, and tkinter for displaying messages.