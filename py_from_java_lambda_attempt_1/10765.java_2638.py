...
Please note that this translation assumes the existence of classes `GDirectedGraph`, `EdgeType` and methods like `add_edge`, `get_vertices`, etc. These should be defined elsewhere in your Python code or imported from other modules.