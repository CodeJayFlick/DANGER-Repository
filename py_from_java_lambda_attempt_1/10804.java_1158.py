...
Note: This is a direct translation of your Java code into Python. However, please note that this may not be the most idiomatic or efficient way to write Python code.