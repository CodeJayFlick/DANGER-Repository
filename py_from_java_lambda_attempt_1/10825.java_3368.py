...
Please note that this is not the exact translation of Java code into Python. The above code is a simplified version and might require some modifications to work correctly with your specific use case.