Here is the translation of the Java interface `VisualGraphLayout` to a Python class:
...
Note that I've used type hints and annotations to indicate the types of variables and function parameters.