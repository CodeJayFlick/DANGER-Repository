...
Please note that the above Python code is a direct translation of your Java code. It may not work as expected without proper testing and debugging due to differences in syntax and semantics between Java and Python.