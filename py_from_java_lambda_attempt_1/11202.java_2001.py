Here is the translation of the Java interface `ToolChest` into a Python class:
...
Note that I've used the `| None` syntax to indicate that some methods may return `None`, and I've also used type hints for method parameters. Additionally, I've assumed that there is a separate class called `ToolTemplate`.