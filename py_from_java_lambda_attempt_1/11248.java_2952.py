Here is the translation of the Java annotation interface `PluginInfo` into a Python class:
...
Note that I've replaced the Java-specific constructs like `@Retention`, `@Target`, and `default` values with Pythonic equivalents. Additionally, I've used properties to implement getter/setter methods for the attributes, as this is a common pattern in Python.