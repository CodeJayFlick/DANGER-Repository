...
```
Note that I've used the `zipfile` module to create a ZIP file and write entries to it. The rest of the code is similar in structure to the original Java code, but with Python syntax and semantics.