...
Please note that Python does not support direct translation of Java code. The above Python code is a manual translation and may require adjustments based on the actual usage in your project.

Also, please be aware that this code might not work exactly like its Java counterpart due to differences between languages such as syntax, semantics, etc.