...
Please note that this is a direct translation of the Java code into Python. The original Java class hierarchy (AbstractAssemblyProduction, AssemblyExtendedGrammar) has been replaced with simple classes in Python (`AssemblyExtendedNonTerminal`, `AssemblySentential`).