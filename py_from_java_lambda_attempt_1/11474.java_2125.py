...
Please note that Python does not have direct equivalent of Java's `ArrayList` and `StringBuilder`. I used Python's built-in list type for the former and a custom class (`StringBuilder`) to mimic the latter.