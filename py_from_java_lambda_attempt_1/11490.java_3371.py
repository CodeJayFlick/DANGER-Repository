...
Please note that this is a direct translation of the Java code into Python. The equivalent classes and methods in Python are not exactly identical to their counterparts in Java due to differences between the two languages.