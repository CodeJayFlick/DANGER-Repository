...
Please note that this is a direct translation of Java code into Python. The `@Override` annotation in the original Java code does not have an equivalent in Python, as it's used to indicate that you're overriding a method from a superclass.