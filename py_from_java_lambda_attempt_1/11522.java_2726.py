...
Note: This is a direct translation of the Java code into Python. It may not be perfect, as there are some differences in syntax and semantics between the two languages.