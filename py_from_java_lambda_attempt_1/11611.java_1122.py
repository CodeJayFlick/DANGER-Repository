...
Please note that the above Python code is an equivalent translation of the given Java code. The actual implementation might vary based on specific requirements and constraints.