...
Note: The `Utils` class and its methods (`signbit_negative`, `calc_mask`, `convert_to_signed_value`) are not provided in the given Java code. You would need to implement these yourself or replace them with equivalent Python functions.