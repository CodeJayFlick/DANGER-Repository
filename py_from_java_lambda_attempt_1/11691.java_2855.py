...
Please note that this is a direct translation of the Java code into Python and may not be exactly equivalent. You might need to adjust it according to your specific requirements, especially if you're using classes or methods from other libraries in your original code.