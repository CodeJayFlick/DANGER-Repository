...
Please note that Python does not support exact equivalent of Java's VectorSTL and TokenPattern. I have replaced them with list comprehension in the above code.