...
Please note that the above translation is not exact. It has been adapted for Python and does not include all Java-specific constructs like packages, imports, etc., which are not necessary in Python.