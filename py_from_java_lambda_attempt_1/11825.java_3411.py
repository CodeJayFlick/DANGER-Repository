...
Please note that the above Python code does not include any actual implementation of methods in `CommentsDBAdapterV0` and `CommentsDBAdapterV1`. You would need to implement these methods based on your specific database schema.