...
Please note that Python does not have direct equivalent of Java's `throws IOException` and `@Override`. Also, the exception handling in Python is different from Java.