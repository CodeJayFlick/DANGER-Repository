...
Note: The Python code does not exactly match the Java code. It's a translation of the given Java code into Python and may require some adjustments to work correctly in your specific use case.