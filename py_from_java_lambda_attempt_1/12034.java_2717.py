...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, error handling in the code has been simplified and may need to be adjusted based on specific requirements.