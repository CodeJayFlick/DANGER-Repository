...
Please note that the `is_register_reference` method in Python assumes that register names start with "R". If your register names have a different prefix, you'll need to adjust this method accordingly.