...
Note: The provided Java code is a part of Ghidra, an open-source reverse engineering framework. This translation may not be exact as Python and Java have different syntaxes and data types.