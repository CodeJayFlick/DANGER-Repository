...
```
Note that I've used the `threading` module to create a lock object for synchronization. Additionally, I've replaced the Java-style type hints with Python's built-in type hinting system using the `type: str`, `type: int`, etc. syntax.