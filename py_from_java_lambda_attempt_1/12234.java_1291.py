...
Please note that Python does not have direct equivalent of Java's `package`, so I removed it. Also, Python has no concept of "magic" byte arrays like in the original code.