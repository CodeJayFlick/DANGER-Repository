...
Please note that this is a translation of the Java code into Python. It may not be exactly equivalent to the original Java code, as some details might have been lost in the process.