...
Please note that this is a direct translation of the given Java code into Python. The original Java code seems to be part of a larger program, and some parts may not work as-is in Python (like `DataType`, `CategoryPath`, etc.).