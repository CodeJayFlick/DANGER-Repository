...
Note that Python does not have an exact equivalent to Java's enum. However, the above class can be used as a drop-in replacement for your original code in most cases.