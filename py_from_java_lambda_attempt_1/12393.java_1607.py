...
Please note that Python does not have direct equivalent of Java's StringBuilder class. It has a built-in string concatenation operation which creates new strings each time, so it may be less efficient for large amounts of data.