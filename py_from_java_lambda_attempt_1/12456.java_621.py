...
Please note that the above Python code does not include any actual implementation of methods in `InjectPayload` class. It is a direct translation from Java to Python and includes only declarations for each method.