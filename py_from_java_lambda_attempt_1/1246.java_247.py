...
Please note that Python does not have direct equivalent of Java's `PathPattern` and `TargetInterpreter`. The given code is a translation into Python syntax.