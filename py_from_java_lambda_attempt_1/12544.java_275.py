Here is a translation of the Java interface `FunctionManager` into Python:
...
Note that this is just one possible translation of the Java interface into Python. The actual implementation may vary depending on your specific requirements and constraints.