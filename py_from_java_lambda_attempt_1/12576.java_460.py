...
Please note that Python does not support Java's `@Override` annotation. Also, the code assumes you have defined classes for `DataType`, `Register`, `Address`, `VariableStorage`, and `Program`.