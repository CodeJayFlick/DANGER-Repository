...
Please note that the `GdbModelImpl` class has been simplified and does not include any functionality from the original Java code. The same applies to the `LinuxPtyFactory`.