...
Please note that Python does not support direct translation of Java code. The above code is a manual conversion from the given Java code into equivalent Python syntax and structure, following PEP 8 style guidelines for coding conventions in Python.