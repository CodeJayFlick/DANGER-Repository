...
Please note that this translation assumes the existence of classes `Program`, `Address`, and `Listing` which are not defined in your code. These classes would need to be implemented separately based on their functionality.