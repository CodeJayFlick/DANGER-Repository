...
This Python code is a direct translation of the given Java code. It includes two test methods: `testEvaluateBinaryLong` and `testEvaluateBinaryBigInteger`. Each method tests different scenarios for evaluating binary operations with long integers or big integers, respectively.