...
Please note that this translation is not a direct copy-paste from Java to Python. The logic and conditions have been adjusted according to the Python syntax and semantics.