...
Please note that the `perform_action`, `capture_dialog` and `close_all_windows_and_frames` methods are not implemented in Python, as they seem to be specific to Ghidra's GUI.