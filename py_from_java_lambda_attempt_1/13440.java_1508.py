...
Note that this is a direct translation of the Java code into Python. The equivalent Python functions are used where possible and some parts have been simplified for better readability.