...
Note that this is a direct translation of your Java code into Python. However, please note that some parts may not work as expected because they are specific to the Tkinter library in Python and might require adjustments for other GUI libraries or frameworks.