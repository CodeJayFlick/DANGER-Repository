...
Please note that the Python code is not a direct translation of Java. It's more like an equivalent implementation, as there are some differences between languages and their syntax.