...
Please note that Python does not have a direct equivalent of Java's `StringBuffer` class. The above code uses the built-in string manipulation methods to achieve similar functionality.