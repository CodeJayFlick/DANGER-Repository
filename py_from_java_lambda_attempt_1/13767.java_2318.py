...
Note that Python's `unittest` module does not have direct equivalents to Java's JUnit and Mockito. Instead, we use the built-in `MagicMock` class from the `mock` module to create mock objects for testing purposes.