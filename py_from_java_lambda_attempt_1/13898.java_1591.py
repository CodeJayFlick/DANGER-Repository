...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation, as the original code was written in Java and doesn't have a straightforward equivalent in Python.