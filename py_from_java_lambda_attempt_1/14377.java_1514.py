...
Note: This Python code is a direct translation of the Java code. However, it does not include any error handling or exception checking that might be present in the original Java code.