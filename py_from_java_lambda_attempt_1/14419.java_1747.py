...
Please note that the Python code is not a direct translation of Java. It's more like an equivalent implementation in Python, considering the differences between both languages and their respective idioms.