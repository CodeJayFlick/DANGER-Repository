...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, the code is translated to use Python's built-in unit testing framework and its equivalents for some Java features like static imports and package names.