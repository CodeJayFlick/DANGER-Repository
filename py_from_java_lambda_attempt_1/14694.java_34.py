...
Please note that Python does not have direct equivalent of Java's `enum` and `interface`. So I used a combination of class and string to achieve similar functionality.