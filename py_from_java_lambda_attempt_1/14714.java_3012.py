...
Please note that Python does not have a direct equivalent to Java's JUnit. The above code uses the built-in `unittest` module for unit testing, but it is used in a slightly different way than JUnit.