...
Please note that this is a direct translation of the Java code into Python, and it may not work as-is without further modifications to fit your actual application logic.