...
This Python code is equivalent to the Java code. It uses threading and time modules from Python's standard library, as well as a Queue class which is used to simulate an ExecutorService in Java.