...
Note that Python does not have direct equivalent of Java's `@BeforeEach` and `@AfterEach`, so we use the setup method to initialize our appender before each test.