Here is the translation of the given Java interface into equivalent Python code:
...
Please note that you would need to implement `vocabulary_contains`, `preprocess_word_to_embed` and `unembed_word` methods in your subclass of the `WordEmbedding` class.