...
Please note that Python does not have direct equivalent of Java's `URI`, so I used the built-in string formatting to create a URI-like string. Also, Python does not support static methods directly like in Java, but you can achieve similar functionality using classmethods or instance methods with default arguments.