...
Note that the `close` method is not implemented in Python as it's not necessary, and also some methods like `throwsIllegalStateWhenNotFitted`, are replaced with Pythonic way of handling this situation.