...
Please note that Python does not support direct translation from Java code. It requires some manual effort and understanding of both languages. The above Python code is an equivalent implementation based on the given Java code's functionality.