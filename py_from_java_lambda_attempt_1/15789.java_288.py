...
This Python code is equivalent to the given Java code. It defines a `TestData` class, an `assert_output_shapes` function and a `Conv1dTest` class with a test method for testing output shapes of convolutional neural networks (CNNs).