...
Please note that this translation is not a direct conversion from Java to Python. It requires some understanding of both languages and their respective idioms.