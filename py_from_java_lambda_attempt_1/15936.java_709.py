...
Note: The JnaUtils class and its methods (`imperative_invoke`, `SparseFormat.DENSE`) have been replaced with equivalent Python code, as they seem to be specific to Java's JNA library.