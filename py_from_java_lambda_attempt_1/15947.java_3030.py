...
Please note that this Python code is not exactly equivalent to the given Java code. The translation was done based on my understanding of the original Java code and its functionality.