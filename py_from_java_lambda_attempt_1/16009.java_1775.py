...
Please note that the above Python code is a direct translation of the given Java code. However, it may not work as expected without proper testing and error handling in real-world scenarios.