...
Please note that this is a direct translation of your Java code into Python. It may require some adjustments based on how you plan to use it in your project, as well as any specific requirements or constraints you have.