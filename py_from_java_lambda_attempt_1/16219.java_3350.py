...
Please note that the above Python code is a direct translation of your Java code. However, it does not include any error handling or exception checking as you would typically do in production-ready code.