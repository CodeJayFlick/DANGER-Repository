...
Please note that the `SpProcessor` class is not fully implemented in this translation. You would need to implement the tokenization and building sentence logic according to your specific requirements.