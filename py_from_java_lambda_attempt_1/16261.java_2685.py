...
Please note that the Python code is not a direct translation of Java to Python. It's more like rewriting the same logic in Python using equivalent libraries and frameworks.