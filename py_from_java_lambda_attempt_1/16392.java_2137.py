...
if __name__ == "__main__":
    main(sys.argv[1:])
```
Note that I've used the `urllib` and `io` modules to handle HTTP requests and file operations respectively. The rest of the code is similar to the original Java code, with some minor adjustments for Python's syntax and semantics.