...
Please note that this translation is not a direct conversion from Java to Python, but rather an adaptation of the code to work in a Python environment. The logic and functionality remain largely the same, but some changes were made to accommodate differences between the two languages.