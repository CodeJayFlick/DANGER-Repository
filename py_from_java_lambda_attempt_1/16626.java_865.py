...
Note: This Python code is not a direct translation of the Java code. It's an equivalent implementation in Python, with some simplifications and assumptions made about the original code.

Also note that I've omitted the `TSStatusCode` enum from the original Java code since it doesn't have a direct equivalent in Python. Instead, I used integer values to represent different status codes. You can modify this code as needed based on your specific requirements.