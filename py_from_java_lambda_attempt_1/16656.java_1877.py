...
Please note that this is a direct translation of the given Java code into Python, and it may not be exactly what you want as there are some differences between Java and Python.