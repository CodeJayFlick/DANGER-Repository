...
Note that the Python code is written in a way to be compatible with Python 3.x and uses some advanced features like type hints, f-strings (Python 3.6+), etc.