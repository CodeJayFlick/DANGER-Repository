...
Please note that Python does not have direct equivalent of Java's `HashMap` and `IOException`. In this translation, I used a dictionary for the labels and annotations, and exceptions are handled using Python's built-in exception handling mechanism.