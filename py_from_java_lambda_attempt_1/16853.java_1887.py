...
Please note that this is a direct translation of the Java code to Python. It might not be exactly what you would write in Python, as it's just an equivalent implementation.