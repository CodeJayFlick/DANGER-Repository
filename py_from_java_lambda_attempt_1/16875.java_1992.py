Here's your Java class translated into Python:
...
Note that Python does not have direct equivalent of Java's `Properties` class. Instead, you can use the built-in dictionary type to store key-value pairs.

Also note that some methods in your original code are just getters and setters for properties, so I've implemented them as such in this translation.