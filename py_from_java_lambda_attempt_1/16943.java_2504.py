...
Please note that Python does not have direct equivalent of Java's `LoggerFactory` and `ThreadName`. Also, the concept of static variables is different in Python. The above code uses a class-level attribute to store the logger instance.