...
Please note that Python does not support direct translation of Java code into Python. The above code is a manual translation and may require some adjustments to work correctly in your specific use case.