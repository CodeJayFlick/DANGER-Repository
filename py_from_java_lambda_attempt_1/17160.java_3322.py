...
Please note that you'll have to import the necessary modules (`re` for regular expressions) and define `IMNode`, `PartialPath`, `set`, `List`, and `Pattern` classes or functions.