...
Please note that this translation assumes the Java code has been simplified for readability. The original code might have more complex logic, and some parts may not translate directly to Python due to differences in language syntax or semantics.