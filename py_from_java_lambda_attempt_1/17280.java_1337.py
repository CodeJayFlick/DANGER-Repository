...
```
Note that I've used Python's built-in `bool` type for the `is_tracing_on` attribute and property. In Python, you don't need to explicitly declare types like Java does with `boolean`.