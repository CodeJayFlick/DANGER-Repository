...
Please note that the translation of Java code to Python may not be straightforward, especially when dealing with complex data structures and multithreading. The above Python code is just one possible way to translate the given Java code into Python.