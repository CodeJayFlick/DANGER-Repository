Here is the translation of the Java interface `IReaderByTimestamp` to a Python class:
...
Note that I've used Python's `list` type to represent the Java arrays, and removed the `throws IOException` clause since Python doesn't have a direct equivalent of Java's exception handling mechanism.