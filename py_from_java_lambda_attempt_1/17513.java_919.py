Here is the translation of the Java enum class into a Python dictionary:
...
This dictionary maps each function name to a dictionary containing the `function_name` and `class_name`.