...
This Python code defines a class `Format` with various static attributes and methods. The constructor of the class initializes its instance variables (`swigName`, `swigValue`) based on whether it was initialized with two arguments or not.