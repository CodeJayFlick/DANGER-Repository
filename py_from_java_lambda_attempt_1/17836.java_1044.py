...
```
Note that I used the `pyiotdb` library to connect to IoTDB and execute SQL queries. Also, I replaced the Java-specific code with Python equivalents, such as using `datetime` instead of `SimpleDateFormat`.