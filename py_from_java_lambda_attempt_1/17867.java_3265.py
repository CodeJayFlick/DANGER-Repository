...
Please note that this is a direct translation of the Java code into Python. The functionality and logic remain the same, but some syntax changes were made to accommodate Python's unique features.