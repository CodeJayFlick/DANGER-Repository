...
Please note that this is a direct translation of the Java code to Python, and it may not be perfect. The original Java code might have some complexities or edge cases that are difficult to translate directly into Python.