...
Please note that the actual implementation of `lldbJNI` and its methods (`SBLanguageRuntime_GetLanguageTypeFromString`, `SBLanguageRuntime_GetNameForLanguageType`) will depend on how you are wrapping your C++ code in Python.