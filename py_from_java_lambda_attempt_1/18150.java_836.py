...
Note that I've made some assumptions about the original Java code. For example, `flip_byte` is not implemented in the original Java code, so it's left as a placeholder method here.