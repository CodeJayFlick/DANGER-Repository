...
Please note that the above Python code is a direct translation of your Java code and may not work as-is. You will need to implement some classes (`MetadataIndexNode`, `TSFileDescriptor`) which are missing in this example.