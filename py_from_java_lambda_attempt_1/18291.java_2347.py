...
```
Note that I've used Python's type hints to indicate the types of variables and function parameters. Additionally, I've replaced Java-style comments with Python-style docstrings.

Also, please note that this is a direct translation from Java to Python, without considering any specific requirements or best practices for Python programming.