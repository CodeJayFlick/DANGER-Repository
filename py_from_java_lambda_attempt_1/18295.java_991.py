Here is the translation of the Java interface `TsFileInput` into Python:
...
Please note that this is a direct translation of the Java interface into Python. The actual implementation would depend on how you want to handle these operations in your specific use case.