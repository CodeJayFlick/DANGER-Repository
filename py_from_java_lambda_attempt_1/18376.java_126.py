...
Note: The code above is not fully implemented. It only translates the Java code to Python and does not include all test cases or methods that are skipped in the original Java code.