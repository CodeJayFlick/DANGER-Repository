...
Please note that this is a direct translation of your Java code into Python. The logic remains the same but you might need to adjust it according to your specific requirements in Python.