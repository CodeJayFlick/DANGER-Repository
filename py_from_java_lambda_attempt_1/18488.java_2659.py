...
Please note that this is a translation of the Java code into Python and may not be exact equivalent as some methods might have different behavior or syntax in Python compared to Java.