...
Please note that this is a simplified translation of the Java code into Python. The original Java code might have more complex logic or dependencies which are not included here.