...
Please note that the translation of Java code into Python is not always straightforward, and there may be some differences in how certain concepts are implemented.