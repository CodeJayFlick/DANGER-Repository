...
Note: The above Python code is a direct translation of the given Java code. However, it might not work as expected because some classes and methods are missing in this example (like `AwsProxyHttpServletRequestReader`, `CountDownLatch`, etc.).