...
def ping_destroy():
    ...
    return jsonify({"message": response})
```
Note that I used Flask as the web framework, and Python 3.x syntax. The code is a direct translation of the Java code to Python, with some minor adjustments for Python's syntax and semantics.