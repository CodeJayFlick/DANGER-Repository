...
Please note that Python does not have direct equivalent of Java's static methods, so I've made the `builder` method an instance method. Also, in Python, we don't need to specify types for variables and function parameters like we do in Java.