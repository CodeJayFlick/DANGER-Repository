Here is the translation of the Java interface `DefaultDynamoClientConfig` to a Python class:
...
Note that I've used Python's type hinting system to indicate the types of variables and method parameters.