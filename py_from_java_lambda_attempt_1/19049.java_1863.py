...
```
Note that I've used the `pymongo` library to interact with MongoDB, and Python's built-in dictionaries (`dict`) to represent the configuration. The rest of the code is a straightforward translation from Java to Python.

Also, please note that this is just one possible way to translate the Java code to Python - there may be other ways to do it as well!