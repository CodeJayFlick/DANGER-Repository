...
Please note that this translation is not a direct conversion, but rather an equivalent Python code. The original Java code has some abstract methods and annotations which are not directly translatable to Python.