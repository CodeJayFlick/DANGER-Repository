...
Please note that Python does not support direct translation of Java code. This is a manual translation and might require some adjustments to work correctly in your specific use case.