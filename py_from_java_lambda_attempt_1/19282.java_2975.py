...
Please note that Python does not have direct equivalent of Java's `@Name`, `@Description`, etc. annotations. These are used for documentation purposes and can be replaced with docstrings in Python, which provide a similar functionality.