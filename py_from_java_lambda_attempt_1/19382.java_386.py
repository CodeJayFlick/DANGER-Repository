...
Please note that Python does not have direct equivalent of Java's static blocks or annotations. The `register_effect` method is used to register the effect, and there are no annotations in this code as they do not exist in Python.