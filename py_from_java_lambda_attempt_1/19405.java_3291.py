...
Please note that Python does not support direct translation of Java code. The above code is a manual translation and may require adjustments to work correctly in your specific use case.

Also, please be aware that this code will raise exceptions if the input data or serialization/deserialization fails.