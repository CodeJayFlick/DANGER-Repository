...
Note that this translation assumes some familiarity with Python and its syntax. It also doesn't include any imports or classes that are specific to Skript (the framework you're using).