...
Please note that this is a direct translation of the given Java code into Python. The `Skript`, `Converters` and some abstract methods (`get_return_type()`) are not implemented in this example as they were part of the original Java class hierarchy.