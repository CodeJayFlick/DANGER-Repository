...
Please note that Python does not have direct equivalent of Java's annotations like `@Name`, `@Description` etc. These are used for documentation purposes and can be achieved in Python using docstrings or other methods.