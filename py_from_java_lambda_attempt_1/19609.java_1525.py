...
Please note that Python does not support Java-like features such as static blocks or annotations. The equivalent code in Python is written with a focus on readability and simplicity.