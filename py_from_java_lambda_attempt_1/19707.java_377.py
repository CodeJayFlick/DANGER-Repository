...
Please note that Python does not have direct equivalent of Java's annotations. The `@property` decorator is used to create getter and setter methods for attributes.