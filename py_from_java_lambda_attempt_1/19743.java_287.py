...
This Python code does not exactly replicate the given Java code. It is a simplified version of it and may require additional modifications to achieve the exact same functionality as the original Java code.