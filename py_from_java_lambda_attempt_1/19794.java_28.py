...
Please note that this is a direct translation of your Java code into Python. It may not be perfect, as some parts might need to be adjusted for compatibility with Python's syntax and semantics.