...
Note that this Python code does not exactly replicate the Java code. It is a translation of the original code into Python and may have some differences in terms of syntax or functionality due to the different nature of the two languages.