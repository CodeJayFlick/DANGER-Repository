...
This Python translation includes the same enum values as the Java original. The `update_component` function has been moved outside of any class definition to match its usage in the Java code.