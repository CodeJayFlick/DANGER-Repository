...
Note: This code assumes that you have a `Language` class with methods for getting lists and values, as well as an `org.bukkit` module with classes like `World`, `Player`, etc. You may need to modify the code based on your specific use case.