...
Please note that Python does not have a direct equivalent to Java's `@Nullable` annotation. In the translation above, I've used the fact that in Python, `None` is often used as a placeholder for null values.