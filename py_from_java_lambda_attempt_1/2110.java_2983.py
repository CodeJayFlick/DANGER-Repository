...
Please note that Python does not have direct equivalent of Java's `interface` and `abstract method`. Instead, we use abstract classes (`ABC`) to achieve similar functionality.