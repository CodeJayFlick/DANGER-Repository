...
Note that the translation is not perfect and some parts of the code are missing. The provided Java code seems to be part of a larger system and it's hard to translate everything without knowing more about this system.