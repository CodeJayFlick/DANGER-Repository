...
Please note that Python does not have direct equivalent of Java's `AutoCloseable` interface. However, the `close()` method in this code is designed to mimic its functionality by terminating and waiting for the process to finish.