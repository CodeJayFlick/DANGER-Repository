...
Please note that Python does not support checked exceptions like Java, so I have removed the `throws` clauses and replaced them with simple error handling.