...
Please note that Python does not support generics like Java, so I had to remove them. Also, some methods were modified slightly due to differences in syntax and functionality between Java and Python.