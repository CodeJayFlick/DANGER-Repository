...
Note that Python does not have an exact equivalent to Java's `@Override` annotation. The methods in this class are intended to override the corresponding methods from a parent or ancestor class.