Here is the translation of the Java interface `TraceModule` into a Python class:
...
Please note that this is a direct translation of the Java interface into Python. You might need to adjust it according to your specific requirements and constraints.

Also, I have used `ABC` (Abstract Base Class) from the built-in `abc` module in Python for implementing abstract methods.