...
Please note that Python does not have a direct equivalent to Java's generics. The type parameters `<X, Y, R>` in the original code are replaced with `object` in this translation, as it is common practice in Python to use `object` for generic types.