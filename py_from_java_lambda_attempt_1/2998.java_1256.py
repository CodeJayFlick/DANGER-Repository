...
Note that Python does not have direct equivalents for Java's Swing and AWT libraries, so I've used the tkinter library to create a GUI. Also, this code doesn't actually do anything with the selected language or compiler spec pair; it just prints some messages.