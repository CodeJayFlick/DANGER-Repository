...
Please note that Python does not have direct equivalent of Java's `GhidraScript`, so I've created a simple class to hold the methods. Also, Python doesn't support multiple inheritance like Java, so you would need to create separate classes for each method if needed.