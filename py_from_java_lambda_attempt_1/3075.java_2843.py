...
Please note that this code is a direct translation of the given Java code into Python. It might not work as expected if you are using it in an actual Ghidra script, because some methods and classes used here may have different behaviors or requirements than their counterparts in Java.