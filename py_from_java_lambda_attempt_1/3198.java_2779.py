...
Please note that this is a direct translation of the Java code into Python. The original code has some complex logic and data structures which might not be directly applicable to all scenarios in Python.