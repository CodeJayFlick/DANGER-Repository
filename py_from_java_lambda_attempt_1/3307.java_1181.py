...
Please note that Python's tkinter library is used for GUI operations. The code does not include all the functionality of your Java class, but it should give you a good starting point to translate the rest of the code into Python.