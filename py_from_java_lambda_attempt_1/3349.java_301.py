...
Note that this code does not include the actual implementation of all classes (e.g., `ProgramMultiUserMergeManager`, `ListingActionContext`) as they are specific to your application.