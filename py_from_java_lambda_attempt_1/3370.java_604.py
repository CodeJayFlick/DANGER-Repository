...
Please note that Python does not have direct equivalent of Java's `public` and `private` access modifiers. In this translation, I've used the convention where methods starting with an underscore are considered private (not accessible from outside the class).