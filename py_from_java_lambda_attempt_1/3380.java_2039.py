...
Please note that this translation assumes a basic understanding of Python programming. The code provided may not be directly executable as it contains abstract methods (`get_selection`) which should be implemented in subclasses.