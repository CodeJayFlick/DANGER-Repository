...
Please note that Python does not have direct equivalent of Java's static methods. Also, the code provided is quite complex and there might be some minor differences in how certain operations are handled between Java and Python due to their different syntax and semantics.