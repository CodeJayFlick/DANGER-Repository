...
This Python code does the same thing as your Java code. It extracts files from a zip file, verifies that it's a valid Ghidra Project Archive (.gar), and then opens the restored project in the Ghidra tool.