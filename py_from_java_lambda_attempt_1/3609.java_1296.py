...
Please note that Python does not have direct equivalent of Java's Swing and AWT libraries. This code uses Tkinter for GUI operations, which is a built-in Python library.