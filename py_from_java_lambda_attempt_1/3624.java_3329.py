...
Please note that this is a direct translation of the Java code into Python. You may need to modify it according to your actual use case and requirements in Python.