...
Note that Python does not have direct equivalent of Java's `package`, so the package declaration has been removed. Also, in Python, we do not need to specify types for variables or method parameters like we do in Java.