...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original Java code seems to have some dependencies on other classes or libraries which are not present in this translation.