...
Please note that this translation is not a direct conversion, but rather an equivalent Python implementation. The original Java code might have some specific features or libraries that are not directly translatable to Python.