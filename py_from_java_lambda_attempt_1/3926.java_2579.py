...
Please note that this is a translation and not an exact copy. The original Java code might have some specific requirements or constraints which are difficult to translate directly into Python.