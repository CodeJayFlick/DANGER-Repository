...
Please note that this is a direct translation of the Java code into Python. The equivalent classes and methods are used in both languages to achieve similar functionality.