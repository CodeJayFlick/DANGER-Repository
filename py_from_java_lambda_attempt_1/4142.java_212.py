...
Please note that this is a direct translation of the Java code into Python. The equivalent Python classes and methods are defined as per the provided Java code, without any modifications or optimizations for better performance in Python.