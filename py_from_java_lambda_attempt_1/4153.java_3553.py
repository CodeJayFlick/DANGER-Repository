...
Please note that the Python code does not exactly replicate the Java code. The translation is done in a way to maintain the same functionality and logic as the original Java code.