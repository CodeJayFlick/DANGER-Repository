...
Note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. Some changes were made to better fit the Python syntax and style.

Also note that some parts of the code are still marked as TODOs because they require more information about how exactly they should be implemented in Python.