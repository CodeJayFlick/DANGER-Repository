...
Please note that this is a direct translation of your Java code into Python. This may not be the most idiomatic or efficient way to write Python code for these specific tasks.