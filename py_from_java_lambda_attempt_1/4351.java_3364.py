...
Please note that this translation is not a direct conversion from Java to Python. Some classes and methods have been renamed or reorganized for better compatibility with the Python language.