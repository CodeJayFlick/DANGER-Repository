...
Please note that this is a Python translation of the Java code, and it may not be exactly equivalent due to differences in language syntax and libraries used.