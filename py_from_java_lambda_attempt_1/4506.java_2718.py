...
Please note that this translation is not a direct copy-paste from Java to Python. Some modifications were made to make the code more idiomatic and efficient in Python, such as using `os.listdir` instead of iterating over files manually, or converting lists into sets when needed.