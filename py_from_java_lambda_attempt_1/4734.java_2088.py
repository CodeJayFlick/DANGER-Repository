...
Note that I've used Python's built-in list and dictionary data structures to replace Java's ArrayList, List, Map, etc. Also, the `@staticmethod` decorator is not needed in Python as it does not have a direct equivalent.