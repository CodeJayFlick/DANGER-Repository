...
Note: This Python code does not include the equivalent of Java's `IOException` and `DuplicateNameException`. These exceptions are specific to Java and do not have direct equivalents in Python.