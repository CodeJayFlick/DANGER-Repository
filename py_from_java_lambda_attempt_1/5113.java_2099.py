...
Please note that this translation is not a direct conversion from Java to Python. It's more of a re-implementation in Python with equivalent functionality.