...
Note that the `DataUtilities` class and some other classes are not defined in your original Java code. You would need to define these or replace them with equivalent Python functionality.

Also note that I've used type hints for function parameters where possible, but you may want to adjust these based on how you're actually using this code.