...
Please note that the above Python code is not a direct translation of the Java code. It's an equivalent implementation in Python with some simplifications and assumptions made to make it more readable and understandable for Python developers.