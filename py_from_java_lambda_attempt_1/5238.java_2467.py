...
"""
```
Note that I've used Python's `@property` decorator to create read-only properties for the methods, and added an `_lock` attribute to ensure synchronization using Python's built-in threading module.