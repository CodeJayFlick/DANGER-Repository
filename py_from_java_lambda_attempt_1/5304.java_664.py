...
Please note that this is a direct translation of the given Java code into Python. The actual implementation might require adjustments based on your specific requirements and domain knowledge.