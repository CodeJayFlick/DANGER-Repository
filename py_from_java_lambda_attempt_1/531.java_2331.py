...
This Python code defines a class `WrapIDebugDataSpaces` with methods that correspond to those in the Java code. The `_invoke_hr` function is left unimplemented as it seems to be related to some kind of invocation or call, which would require additional information about how this should work.

Please note that you will need to implement the logic for invoking HR (`_invoke_hr`) based on your specific requirements and use cases.