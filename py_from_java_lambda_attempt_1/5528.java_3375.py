...
Please note that Python does not have direct equivalent of Java's static methods, so I've used a class `StringUtilities` to hold the method. Also, Python does not support directly accessing private variables or methods from another class like we do in Java with getters and setters.