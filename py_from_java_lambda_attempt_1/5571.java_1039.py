...
Please note that this translation does not include all details, as Python and Java have different syntaxes. For example, there is no direct equivalent of the `@Override` annotation in Python.