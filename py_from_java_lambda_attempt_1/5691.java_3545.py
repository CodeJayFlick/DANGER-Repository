...
Note that I have used Python's type hinting feature to indicate the types of variables and function parameters. This is optional in Python, but it can be helpful for documentation purposes.

Also note that `FSRL` class has not been provided in your code snippet, so you would need to implement this class separately based on how you want it to work.