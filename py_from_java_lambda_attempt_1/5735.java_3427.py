...
Please note that the above Python code is a direct translation of the given Java code and may not work exactly as expected without proper implementation of classes like `NewLanguagePanel` and `LcsSelectionListener`.