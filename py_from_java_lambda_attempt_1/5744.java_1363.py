...
Please note that Python does not support direct translation of Java code. The above Python code is a manual translation and may require adjustments to work correctly in your specific use case.

Also, please be aware that the `ImageManager`, `FSBUtils`, `ProgramMappingService` classes are not part of standard Python libraries and you would need to implement them yourself or import them from other modules.