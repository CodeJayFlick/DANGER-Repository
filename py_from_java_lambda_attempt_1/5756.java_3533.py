...
Please note that Python does not support direct translation of Java code. The above Python code is a manual translation and may require some adjustments to work correctly in your specific environment.