...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original Java code seems to have some dependencies on other classes or modules which are not included in this translation (e.g., `BatchInfo`, `Msg`).