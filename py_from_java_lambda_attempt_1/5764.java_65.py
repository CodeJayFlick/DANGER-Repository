...
Note that Python does not have direct equivalent of Java's `private` and `public` access modifiers. Instead, we use the convention of prefixing attribute names with underscores to indicate they are intended to be private (i.e., only accessible within the class).