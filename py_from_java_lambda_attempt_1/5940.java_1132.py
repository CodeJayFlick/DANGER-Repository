...
Please note that this is a direct translation of the given Java code into equivalent Python. The provided code uses various Java-specific classes and methods which do not have direct equivalents in Python. Therefore, some modifications might be necessary to make it work as expected with your specific use case.