...
Please note that Python doesn't have direct equivalent of Java's `ProgramDB` and `UniversalID`. I've replaced them with dictionaries. Also, the code is simplified as much as possible while still maintaining its original functionality.