...
Please note that this is a direct translation of the Java code into Python. The original code was written in Java and uses various libraries and frameworks which are not directly applicable to Python.