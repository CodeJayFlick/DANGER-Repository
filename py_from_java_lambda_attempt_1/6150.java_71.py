...
Note: The `XmlUtilities` class and its methods (`xml_to_bytes`, `bytes_to_xml`, `has_invalid_xml_characters`) are not part of the Python standard library. You would need to implement these yourself or use a third-party library that provides similar functionality.

Also, this code uses the `unittest` module for testing, which is included in the Python Standard Library.