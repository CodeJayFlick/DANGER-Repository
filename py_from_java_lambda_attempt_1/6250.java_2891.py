...
Note that I've skipped some tests as they are not implemented in Python. You would need to fill those functions according to your requirements and test cases.