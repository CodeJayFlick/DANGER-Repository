...
Please note that this is a translation of the Java code into Python. It's not a direct copy-paste, but rather an interpretation of how to translate it. The actual implementation may vary depending on specific requirements and constraints.

Also, please be aware that some parts of the original code might require additional modifications or changes when translated from one language (Java) to another (Python).