...
Please note that this is a direct translation of the given Java code into equivalent Python. It does not include any error handling or exception checking as it was present in the original Java code.