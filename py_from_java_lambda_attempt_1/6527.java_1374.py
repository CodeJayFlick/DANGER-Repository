...
Please note that this code is not a direct translation of the given Java code. It's more like an equivalent Python implementation, as some parts might be different due to language differences and limitations.