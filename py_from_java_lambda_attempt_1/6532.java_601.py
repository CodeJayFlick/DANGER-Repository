...
Please note that this code is a translation of the original Java code and may not work as-is. You will likely need to modify it to fit your specific use case and Python environment.