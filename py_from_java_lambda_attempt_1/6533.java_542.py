...
Note that this translation is based on the assumption that you have a `ghidra_framework_project_tool` module with functions like `launch_tool`, `set_auto_save_enabled`, etc. These functions are not defined in your original Java code, so I had to leave them as-is.