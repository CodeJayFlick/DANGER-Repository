Here is the translation of the Java interface `DbgEventsListener` into a Python class:
...
Note that the `pass` statements are placeholders for actual implementation. You would need to replace these with your own code based on how you want to handle each event in Python.