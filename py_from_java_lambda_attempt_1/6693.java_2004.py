...
Note that Python does not have direct equivalent of Java's private variables. However, we can achieve similar functionality by using a property decorator (`@property`) to control access to the attributes.