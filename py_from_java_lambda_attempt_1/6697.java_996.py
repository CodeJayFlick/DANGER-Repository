...
Please note that Python does not have direct equivalent of Java's access modifiers (public/private/protected). In this translation, I used the `@property` decorator to create getter and setter methods for each attribute. This allows you to control how these attributes are accessed and modified from outside the class.