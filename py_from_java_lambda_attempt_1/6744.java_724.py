...
```
Note that I've used the `tkinter` library for creating a simple GUI-like interface, as there is no direct equivalent of Java's Swing or AWT in Python. The rest of the code has been translated to Python using standard syntax and semantics.