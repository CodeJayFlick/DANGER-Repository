...
Please note that the `ByteBlock` class is not part of your original code. I added it as an example to demonstrate how you can use the `ByteBlockInfo` class in Python.