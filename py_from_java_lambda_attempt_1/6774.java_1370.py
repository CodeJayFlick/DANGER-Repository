...
Please note that the Python code does not exactly match the Java code. The provided Java code has several classes and methods which are not implemented in this translation, such as `DecompilerScriptUtils`, `HighFunction`, etc., because they were missing from your original question.