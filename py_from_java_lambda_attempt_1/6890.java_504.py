...
Note that Python does not have direct equivalent of Java's `package`, so I removed it. Also, the class is defined as a simple Python class without any explicit package declaration.