...
Please note that Python does not support direct translation of Java code. The above Python code has been written based on the functionality provided in your original Java code.