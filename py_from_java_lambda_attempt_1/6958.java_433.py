...
Note that this translation is not a direct copy-paste from Java to Python. Some changes were made to make the code more idiomatic and efficient in Python.