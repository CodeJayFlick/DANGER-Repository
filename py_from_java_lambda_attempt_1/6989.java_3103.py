...
Please note that this is a direct translation of your Java code into Python. It may not be perfect, as there might be some differences between the two languages.