...
Please note that Python does not have direct equivalent of Java's static methods. In the given code, I used class method decorator `@staticmethod` to achieve similar functionality.

Also, please note that this is a translation and may require some adjustments based on your specific use case as it might not be 100% identical in terms of syntax or semantics with the original Java code.