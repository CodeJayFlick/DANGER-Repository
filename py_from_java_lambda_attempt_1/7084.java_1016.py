...
Please note that this is a direct translation of the given Java code into Python, and it may not be exactly equivalent to the original Java code due to differences in syntax and semantics between the two languages.