...
Note that this translation assumes a basic understanding of the provided code and its functionality. The actual implementation may vary based on specific requirements or constraints.