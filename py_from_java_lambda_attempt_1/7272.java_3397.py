...
Please note that this is a direct translation of Java code into Python. It may not be perfect and might require some adjustments to work correctly in your specific use case.

Also, please note that the `CpioArchiveEntry` class has been simplified as it seems like there are many attributes which were present in the original Java code but have been removed here for simplicity.