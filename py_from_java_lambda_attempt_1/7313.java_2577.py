...
Note that I've left out some parts of the code, such as `StructConverterUtil.toDataType()` and `StringDataType`, because they don't have direct equivalents in Python.