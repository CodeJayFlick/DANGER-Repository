...
def remove_empty_fragments(program):
    ...
    pass
```
Note that I've left some functions unimplemented (`to_addr`, `create_data`, `change_format_to_string`, `create_fragment`, and `remove_empty_fragments`) as they were not provided in the original Java code. You'll need to fill these in according to your specific requirements.

Also, keep in mind that this is a direct translation of the Java code to Python, so some syntax and semantics may differ slightly between the two languages.