...
Please note that I've not translated all classes (`ISO9660BootRecordVolumeDescriptor`, `ISO9660VolumeDescriptor`) as they are not provided in the given Java code. You would need to implement these based on their equivalent Java counterparts.

Also, Python does not have direct equivalents of some Java constructs like HashMaps and ArrayLists. I've used dictionaries (Python's hash-based data structure) for storing key-value pairs and lists for storing sequences of values.