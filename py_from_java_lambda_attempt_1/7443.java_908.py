...
Please note that Python does not have direct equivalent of Java's `Address` class, so I replaced it with a simple integer. Also, in Python, we don't need to explicitly specify the type of variables like we do in Java.