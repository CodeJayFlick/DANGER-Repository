...
Please note that this is a direct translation of the Java code into Python. The resulting Python code may not be exactly equivalent to the original Java code in terms of performance or functionality, as some differences exist between the two languages.