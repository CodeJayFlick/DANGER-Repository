...
Please note that this Python code is a direct translation of the given Java code and may require additional setup or imports to work correctly in your environment.