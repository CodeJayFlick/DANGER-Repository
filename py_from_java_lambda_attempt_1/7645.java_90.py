...
Please note that this is a direct translation of the Java code into Python. The actual implementation might require additional modifications to work correctly in a Python environment, especially with regards to threading and synchronization.