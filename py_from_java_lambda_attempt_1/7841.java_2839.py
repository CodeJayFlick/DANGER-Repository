...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation based on the given code, as some parts are missing or unclear in the original Java code.