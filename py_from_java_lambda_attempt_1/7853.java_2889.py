...
Note: Python does not have direct equivalent of Java's StringBuilder class. It has a built-in string type that can be concatenated using the '+' operator or by calling methods like 'join' and 'format'.