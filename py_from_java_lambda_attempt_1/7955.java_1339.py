...
Please note that this is a direct translation of the given Java code into Python. The actual functionality may not work as expected without proper testing and error handling in place.