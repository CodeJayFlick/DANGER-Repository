...
Please note that Python does not have direct equivalent to Java's abstract classes and interfaces. Also, some methods in your code are missing their implementations (like `parse_file_info_name`), so I've left them as is.