...
Please note that this translation is based on my understanding of your requirements and may need further adjustments depending on how you plan to use these classes in your Python program.