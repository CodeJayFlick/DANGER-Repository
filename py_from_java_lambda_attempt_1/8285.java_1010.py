...
Please note that this is a direct translation of the given Java code into Python. It does not include any actual implementation details as they are missing in the provided Java code.