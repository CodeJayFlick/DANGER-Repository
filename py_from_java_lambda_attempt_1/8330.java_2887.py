...
Please note that the Python code does not exactly replicate the Java code. It is a translation of the logic into equivalent Python syntax and structure.