...
Note that I did not implement `MsProperty` and `Numeric` classes as they were not provided in the original Java code. You would need to fill them out based on your specific requirements.