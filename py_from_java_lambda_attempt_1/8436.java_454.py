...
Please note that Python does not have direct equivalent to Java's `throws` keyword. The exception handling mechanism in Python is different from Java and hence I did not include any specific error handling for now.