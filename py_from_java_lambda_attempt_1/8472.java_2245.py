...
Note that I've made some assumptions about how you might want to implement certain parts of this code. For example, the `RecordNumber` class and its method are left as stubs because they depend on your specific implementation details.