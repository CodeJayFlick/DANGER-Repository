...
Please note that this is a direct translation of the Java code to Python. The original code seems to be part of an application called GHIDRA and might require additional libraries or classes not included here.