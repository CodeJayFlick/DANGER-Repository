...
This is a direct translation of your given Java code into equivalent Python syntax, using concepts like class definitions, inheritance (`super().__init__`), property decorators (the `@property` decorator), and string formatting with f-strings.