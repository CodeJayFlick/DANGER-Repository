...
Please note that this is a direct translation of the Java code into Python, and it may not be exactly equivalent in terms of functionality or performance.