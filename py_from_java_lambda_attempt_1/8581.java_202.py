...
Please note that the above Python code is a direct translation of the Java code and may require additional modifications to work correctly in a Python environment.