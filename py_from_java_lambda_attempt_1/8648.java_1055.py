...
Please note that this is a direct translation of the Java code into Python. The equivalent classes and methods in Python are `DiffMergeAllAction` and `DiffApplySettingsProvider`.