...
Please note that Python does not have direct equivalent of Java's static and final keywords. In this code, I've used class variables to achieve the same effect as `static` and `final`.