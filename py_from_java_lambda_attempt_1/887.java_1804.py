...
Note that this Python code does not exactly replicate the Java code. It's a translation of the given Java code into Python, but it may require some adjustments to work correctly in your specific use case.