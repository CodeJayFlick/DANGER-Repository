...
Please note that this translation assumes you have a `ResourceManager` class to load the icon. In actual implementation, you would need to replace `self.ICON = None` with code that loads the icon using `ResourceManager`.