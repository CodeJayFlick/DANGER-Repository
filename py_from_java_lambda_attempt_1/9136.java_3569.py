...
Please note that this is a translation of the Java code into Python. The actual functionality may not be exactly equivalent due to differences in syntax and semantics between the two languages.