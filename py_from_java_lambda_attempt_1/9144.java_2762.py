...
if __name__ == '__main__':
    unittest.main()
```
Note that I've used the `unittest` module to define a test case class, and the `assertEqual` method is equivalent to Java's `assertEquals`. The rest of the code should be self-explanatory.