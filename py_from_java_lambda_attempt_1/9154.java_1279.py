...
Please note that this code is not a direct translation of the Java code. Python does not support multi-threading and hence some parts have been modified to suit Python's syntax and semantics.