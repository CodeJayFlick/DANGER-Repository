...
Please note that this is a direct translation of the given Java code into Python. The original code was written for a specific context and may not work as-is in your application, especially if it relies on other parts of the system or libraries that are not present here.