...
Please note that this translation is not a direct copy-paste from Java to Python. It's an equivalent implementation in Python using tkinter library for GUI operations and PIL (Python Imaging Library) for image processing.

The `OptionDialog` class mentioned in the original code seems to be missing, so I've omitted it here as well.