...
Please note that the translation is not a direct conversion from Java to Python. The code has been modified and optimized according to Python's syntax and best practices.