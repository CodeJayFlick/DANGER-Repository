...
Please note that I have not tested this code. It is a direct translation from Java to Python and may require some adjustments based on your specific use case.