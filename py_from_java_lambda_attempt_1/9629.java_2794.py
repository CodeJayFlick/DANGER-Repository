...
Please note that this translation is not a direct conversion, but rather an equivalent implementation in Python. The Java code has been rewritten to conform to the conventions and idioms of the Python language.