...
Please note that this translation is not a direct conversion, but rather an adaptation of the Java code to Python. Some parts may have been modified or omitted due to differences in syntax and functionality between the two languages.