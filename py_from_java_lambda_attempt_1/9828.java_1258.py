...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, the `hashCode()` and `equals()` methods are implemented as per Python's conventions.