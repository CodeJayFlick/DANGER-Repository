...
Please note that Python does not have direct equivalent of Java's `NumberFormat` and `DocumentFilter`. I've used Python's built-in string manipulation functions to achieve similar functionality.