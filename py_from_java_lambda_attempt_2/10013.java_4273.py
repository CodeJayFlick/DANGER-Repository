...
Please note that the `new_number_column_constraint_provider`, `parse_constraint_value`, `run_swing` and `wait_for_swing` functions are not implemented in this code. They were present in the original Java code, but their Python equivalent is unknown without more context about what they do.