...
Please note that this is a translation of the Java code into Python. It's not necessarily correct or complete, as it may require adjustments to work correctly in your specific use case.