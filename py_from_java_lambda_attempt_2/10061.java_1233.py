...
This Python code does not exactly replicate the Java code. It is a translation of the provided Java code into equivalent Python, but it may not work as expected in all cases due to differences between the two languages.