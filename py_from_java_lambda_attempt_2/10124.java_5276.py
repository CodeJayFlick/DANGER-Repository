...
Please note that Python does not support checked exceptions like Java. Therefore, the `IOException` and `UnsupportedOperationException` are raised directly in the methods instead of being wrapped inside a try-except block.