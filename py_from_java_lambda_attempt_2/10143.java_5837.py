...
This Python code is equivalent to the Java code provided. It uses the `unittest` module for unit testing and the `tempfile` module for creating a temporary directory. The rest of the logic remains similar, with some minor adjustments due to differences in syntax between Java and Python.