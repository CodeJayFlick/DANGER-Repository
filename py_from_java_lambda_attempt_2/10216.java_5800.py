...
Note that Python does not have an exact equivalent to Java's `@Override` annotation, as it is primarily used for method overriding and Python doesn't require explicit overrides.