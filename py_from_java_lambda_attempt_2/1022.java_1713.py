...
Please note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. The actual code may need adjustments based on the specific requirements and constraints of your project.