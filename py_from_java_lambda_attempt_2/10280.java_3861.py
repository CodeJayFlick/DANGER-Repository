...
Please note that this is a direct translation of the Java code into Python. The logic and functionality may not be exactly equivalent due to differences in language syntax and semantics.