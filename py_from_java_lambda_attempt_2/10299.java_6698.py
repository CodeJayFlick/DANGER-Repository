...
```
Note that I used the `enum` module from Python's standard library to work with enums. Also, some methods like `fire_property_change()` are not implemented in this translation as they were part of Java code and may require additional implementation for Python.