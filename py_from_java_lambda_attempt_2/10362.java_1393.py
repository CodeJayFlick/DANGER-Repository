...
Please note that Python does not have direct equivalent of Java's `byte`, `short` and `int`. It uses built-in types like `int`, `float`, etc. Also, Python's string manipulation is different from Java's.