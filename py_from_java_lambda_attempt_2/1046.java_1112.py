...
Note: This code assumes that `WrapIDebugHostModule1`, `WrapIDebugHostModule2`, `new_IDebugHostModule2_IID_IDEBUG_HOST_MODULE2()`, and `new_IDebugHostModule1_IID_IDEBUG_HOST_MODULE()` are defined elsewhere in the Python code.