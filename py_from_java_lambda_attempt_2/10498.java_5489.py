...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original Java code seems to have some issues with array indices and null values, which I did my best to handle correctly in the Python version.