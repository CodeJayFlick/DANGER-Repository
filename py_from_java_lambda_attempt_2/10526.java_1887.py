...
```
Note that I used the `io` module from Python's standard library to implement the input/output operations. The rest of the code is a direct translation of the Java code, with some minor adjustments for Python syntax and semantics.