...
Please note that this is a direct translation of the given Java code into Python. The functionality and logic may not be exactly equivalent due to differences between languages.