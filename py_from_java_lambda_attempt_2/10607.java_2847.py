...
Please note that the above Python code is not a direct translation of the Java code. It's an equivalent implementation in Python, and it may have some differences due to language-specific features or libraries used.