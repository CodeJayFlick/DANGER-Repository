...
Note: The `ResourceManager` class and the `Icon`, `Color`, and other classes are not defined in this code. They should be implemented according to your requirements.