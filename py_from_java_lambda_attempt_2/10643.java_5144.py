...
Note: This code assumes that you have a class `Application` and an exception type `IllegitimateArgumentException`. If these are not present in your Python environment, they will need to be defined or replaced with the equivalent.