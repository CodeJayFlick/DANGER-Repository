...
Note that Python's `deque` class is used to simulate a stack, and the equivalent methods (`push`, `pop`, etc.) are implemented using standard Python operations. The test cases have been modified accordingly.