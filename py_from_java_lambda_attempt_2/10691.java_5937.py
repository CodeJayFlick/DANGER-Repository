...
Note that I've replaced Java's `@Test` annotations with Python's test framework, and used Python's built-in data structures like lists and dictionaries instead of Java's.