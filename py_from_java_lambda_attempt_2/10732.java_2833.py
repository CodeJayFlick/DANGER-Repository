Here is the translation of the Java interface `GDirectedGraph` into a Python class:
...
Please note that the Python code does not exactly replicate the Java interface. It's more like an implementation based on what I understood from your question.