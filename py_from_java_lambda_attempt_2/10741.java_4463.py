...
Please note that the above Python code is a direct translation of your Java code. However, it may require some adjustments to work correctly in a Python environment.