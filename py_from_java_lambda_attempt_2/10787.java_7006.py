...
Note that I have not translated the Java code into Python exactly. Instead, I have written equivalent Python code based on my understanding of what the original Java code does.