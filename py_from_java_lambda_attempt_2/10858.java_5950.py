...
Please note that Python's tkinter module is used here, which provides a way to create GUIs. The `ScrolledText` widget from tkinter is used as an equivalent of Java's JTextArea.