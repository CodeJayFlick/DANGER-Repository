...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The `LinkDatabase` class in the original Java code has been left as-is because its implementation was not provided.