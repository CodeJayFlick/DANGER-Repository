...
Please note that Python does not have direct equivalent to Java's `enum` or `interface`. The above code is a translation and may require adjustments based on your specific requirements.