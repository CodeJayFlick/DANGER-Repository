...
Please note that Python does not support exact equivalent of Java's `Comparable` interface. The `__lt__` method is used to implement the comparison logic in this translation.