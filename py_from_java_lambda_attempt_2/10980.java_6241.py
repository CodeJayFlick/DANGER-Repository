Here is the translation of the Java interface `MergeProgressModifier` into a Python class:
...
Note: I've kept the method bodies empty as they are not implemented in Java either, and Python doesn't support abstract methods like Java does with interfaces.