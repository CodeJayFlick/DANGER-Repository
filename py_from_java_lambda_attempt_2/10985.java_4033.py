...
Please note that Python does not have direct equivalent of Java's `DataFlavor` and `DnDConstants`. Also, the code is written in a way to mimic the original Java code as closely as possible.