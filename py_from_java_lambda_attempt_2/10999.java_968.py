...
Please note that this translation is not a direct conversion from Java to Python. The code has been rewritten in a way that makes it more idiomatic and efficient for the Python language.

Also, please be aware that some parts of the original code may have been simplified or modified due to differences between Java and Python.