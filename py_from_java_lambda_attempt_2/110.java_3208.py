...
Please note that this is a direct translation of the Java code into Python. The provided Java code seems to be part of an application and may not work as-is in Python due to differences between languages (e.g., `ArrayList` vs `list`, `HashMap` vs `dict`).