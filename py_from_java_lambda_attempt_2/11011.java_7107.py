...
Please note that Python does not support the same level of type safety as Java. The types are included for documentation purposes only, but they do not affect the runtime behavior of your code.

Also, please be aware that this is a direct translation and might require some adjustments to work correctly in a Python environment.