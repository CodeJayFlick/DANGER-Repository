...
Please note that this is a direct translation of the Java code into Python. You will need to implement the `_invoke_hr` function and define `VTIndices`, `WString`, etc., as they are not part of standard Python libraries.