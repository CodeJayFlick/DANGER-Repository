...
Note that Python does not have a direct equivalent to Java's `Serializable` interface. Instead, we use the built-in `pickle` module for serialization and deserialization of objects.