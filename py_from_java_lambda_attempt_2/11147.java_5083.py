...
Please note that Python does not support direct translation from Java code. The above Python code is a manual translation and may have some differences in terms of syntax or functionality compared to the original Java code.