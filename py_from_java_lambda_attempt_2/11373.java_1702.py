...
Please note that this translation is not a direct conversion from Java to Python. The code has been modified and simplified for better readability in Python.