...
Note that Python does not have direct equivalent of Java's static initialization block. The `_solver` variable is created and initialized in the `get_solver()` method.