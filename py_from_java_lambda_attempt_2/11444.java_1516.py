...
```
Note that I've used Python's type hinting system to indicate the types of variables and function parameters. This is not strictly necessary for the code to work, but it can help with readability and maintainability.

Also, I've replaced Java's `ArrayList` with a simple list comprehension in the `get_data_type_components` method.