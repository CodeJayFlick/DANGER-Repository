...
Please note that this is a direct translation of the Java code into Python. The actual implementation details may vary depending on your specific requirements and constraints.

Also, please be aware that some parts of the original Java code have been omitted or modified to fit the Python syntax and semantics.