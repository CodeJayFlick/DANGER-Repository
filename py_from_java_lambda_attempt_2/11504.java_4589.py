...
Please note that the `ConstructState`, `PcodeOp` and other classes are not defined in this code. They would need to be implemented separately based on your specific requirements.