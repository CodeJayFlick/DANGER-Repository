...
Please note that the above Python code is a direct translation of your given Java code. It may not be perfect, and you might need to adjust it according to your specific requirements or the context in which this code will run.