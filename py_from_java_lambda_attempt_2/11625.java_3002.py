...
Note that I've used Python's built-in `int` and `BigInteger` types, as well as its exception handling mechanism. The `_calc_mask` method is not implemented in this translation, as it was missing from the original Java code.