...
Please note that Python does not have a built-in `BigInteger` class like Java. The above code uses the `decimal` and `fractions` modules to simulate this functionality.