...
Please note that Python does not have direct equivalents for Java's `VectorSTL` and `MutableInt`. I replaced them with built-in list and int types respectively.