...
Please note that Python does not have an exact equivalent to Java's `@Override` annotation. The `__str__` method in the above code is used as a replacement for the overridden `toString()` method from the original Java code.