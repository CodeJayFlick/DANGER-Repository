...
Note that I have used abstract methods in the Python code as well. Also, please note that this is a direct translation of Java to Python and may require some adjustments based on your specific requirements.