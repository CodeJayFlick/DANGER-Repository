...
Please note that this is a direct translation of the Java code into Python. It may not be perfect, and you might need to adjust it according to your specific requirements or environment.