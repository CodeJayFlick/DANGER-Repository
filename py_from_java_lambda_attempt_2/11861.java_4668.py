...
Please note that this is a direct translation from Java to Python. You may need to adjust it according to your specific requirements or based on how you want to implement certain functionalities in Python.