...
Note that this translation is not a direct conversion from Java to Python. Some changes were made to the code structure and syntax to conform to Python's style.