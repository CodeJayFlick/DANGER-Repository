...
This Python code is equivalent to the provided Java code. Note that some methods in the original Java code are not implemented here as they were not present in the given code snippet (like `getRecord`, `getRecords`, and others).