...
Please note that this is a direct translation of the Java code into Python. You may need to adjust it according to your specific requirements and the actual implementation details in your project.