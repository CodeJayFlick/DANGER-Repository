...
Please note that Python does not have direct equivalent of Java's `package`, `import` statements. Also, Python doesn't support checked exceptions like Java. The code is written in a way to handle the exceptions using try-except blocks.