...
Please note that this is a translation of the Java code into Python. The original intent and functionality may not be exactly preserved in the translated code due to differences between languages.