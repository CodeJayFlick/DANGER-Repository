...
Please note that Python does not have a direct equivalent to Java's `byte` type. The closest is the built-in integer type, which can be used as needed in this code.