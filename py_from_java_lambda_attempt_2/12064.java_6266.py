...
Note that I have not translated the entire Java code into Python. Instead, I have focused on translating specific parts of the code to give you an idea of how it can be done in Python.