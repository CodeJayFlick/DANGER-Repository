...
Note: This is a direct translation of the given Java code into Python. The provided code does not include any error handling or exception handling which might be necessary in real-world scenarios.