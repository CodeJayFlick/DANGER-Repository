...
Please note that this is a simplified translation and may not cover all the edge cases. The Java code seems to be part of an existing system, so it might require more context or additional information to fully translate it into Python.