...
Note: Python does not have direct equivalent of Java's `Arrays.binarySearch()` and `HashMap`. You can use the built-in list methods to achieve similar functionality.