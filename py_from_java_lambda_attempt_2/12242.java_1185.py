...
Please note that Python does not support the concept of static variables like Java. So, I have removed `SETTINGS_DEFS` and made it a class variable instead. Also, there is no direct equivalent to Java's `@Override` annotation in Python.