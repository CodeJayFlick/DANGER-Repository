...
Please note that Python does not have direct equivalent to Java's `@Override` annotation. Also, in Python, we do not need to explicitly define getters and setters for properties like in Java.