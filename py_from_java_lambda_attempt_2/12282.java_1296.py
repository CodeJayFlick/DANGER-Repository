...
Note: Python does not have direct equivalent of Java's WeakSet. The above code uses a regular set to store the listeners and it is up to you how you want to manage this list (e.g., by periodically cleaning out weak references).