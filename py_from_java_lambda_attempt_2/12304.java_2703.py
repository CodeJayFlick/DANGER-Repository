...
Please note that this is a direct translation of the Java code into Python. The equivalent Python classes may not exactly match their Java counterparts in terms of functionality or behavior.