...
Please note that Python does not have direct equivalent of Java's `static` keyword. In the given code, I used class methods to achieve similar functionality as static methods in Java.