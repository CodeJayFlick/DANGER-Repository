...
Please note that Python does not have direct equivalent of Java's StringBuilder class. The above code uses the built-in string concatenation feature to build the XML string.