...
Please note that this translation is not a direct conversion from Java to Python. The code has been adapted and modified to fit the syntax, semantics, and idioms of Python.