Here is the translation of the Java interface `Language` into a Python class:
...
Note that the Python code does not include any actual implementation for these methods. Instead, each method is marked as `raise NotImplementedError` to indicate that subclasses should provide their own implementations.