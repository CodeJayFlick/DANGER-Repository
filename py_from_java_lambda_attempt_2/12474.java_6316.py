...
Please note that Python does not have a direct equivalent to Java's Comparable interface. However, you can implement your own comparable class and use it as shown above.

Also, the `Language`, `CompilerSpec`, `LanguageDescription` and `CompilerSpecDescription` classes are assumed to be implemented elsewhere in the codebase or imported from other modules.