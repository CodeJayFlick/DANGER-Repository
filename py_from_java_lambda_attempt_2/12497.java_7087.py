...
Note that this translation assumes some classes and methods are missing from the original Java code, such as `Register`, `BigInteger`, etc., which have been left out for simplicity.