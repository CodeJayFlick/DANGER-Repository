...
This translation preserves the original structure and functionality of the Java code, but note that some aspects may need to be adjusted based on how you choose to implement equivalent Python concepts (e.g., properties vs getter/setter methods).