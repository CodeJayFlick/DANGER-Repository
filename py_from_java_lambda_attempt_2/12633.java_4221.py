...
Note that I have not implemented `PcodeDataTypeManager`, `AddressXML` and `VariableStorage` classes as they seem to be specific to Ghidra, a reverse engineering framework.