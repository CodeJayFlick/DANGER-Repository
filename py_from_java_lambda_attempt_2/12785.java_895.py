...
Please note that Python does not support Java's `@Override` annotation. Also, the translation of Java code to Python may require some adjustments as both languages have different syntax and semantics.