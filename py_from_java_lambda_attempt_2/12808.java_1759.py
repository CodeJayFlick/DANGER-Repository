Here is the translation of the Java interface `RangeMapAdapter` into Python:
...
Note that the Python code does not have direct equivalents for Java's `public`, `throws`, and `@param` annotations.