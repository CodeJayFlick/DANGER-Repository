...
Please note that the Python code does not exactly replicate the Java code. The translation is based on my understanding of what you want to achieve with your code.