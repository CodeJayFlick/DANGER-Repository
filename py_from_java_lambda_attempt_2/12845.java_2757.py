...
Note that I used Python's built-in `property` decorator to create getter and setter methods for the instance variables. This is equivalent to Java's private fields with public getters and setters.