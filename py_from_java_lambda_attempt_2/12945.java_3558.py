...
Please note that this is a direct translation from Java to Python. It might not be perfect as there are some differences in syntax between these two languages.