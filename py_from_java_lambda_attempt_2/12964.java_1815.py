...
Note that this is a direct translation of the Java code into Python. The equivalent functionality may not be exactly identical due to differences in language syntax and semantics.