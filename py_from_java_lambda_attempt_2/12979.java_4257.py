...
Please note that Python does not support direct translation from Java code. The equivalent Python code may look different but it should achieve the same functionality as the original Java code.