...
Note that Python does not have direct equivalents for Java's `throws` keyword and the exceptions it can throw. Instead, we use Python's built-in exception handling mechanism to handle any unexpected situations in our code.