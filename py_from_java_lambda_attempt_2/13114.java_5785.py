...
Note that the `BigInteger` class is a simple wrapper around Python's built-in integers. The `PcodeOp` and `LowlevelError` classes are also just wrappers for Python exceptions.