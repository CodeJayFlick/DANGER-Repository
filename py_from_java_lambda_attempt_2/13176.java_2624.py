...
Please note that Python does not have a direct equivalent to Java's `long` data type. In this translation, I used the built-in integer types (`int`) and floating-point numbers (`float`). If you want to work with larger integers in Python, consider using libraries like `gmpy2` or `sympy`.