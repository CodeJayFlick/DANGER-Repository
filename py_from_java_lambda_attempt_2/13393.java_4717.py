...
Please note that this is a direct translation of the given Java code into Python. It may not be optimal or idiomatic in terms of Pythonic coding practices, but it should work as expected.