...
Note that Python does not have direct equivalents for Java's `package`, `public class`, and other constructs. The above code is a straightforward translation of the provided Java code into equivalent Python syntax.