...
Note: This Python code is not exactly equivalent to the Java code. It's more of an interpretation and translation, as some parts might be missing or different due to language differences.