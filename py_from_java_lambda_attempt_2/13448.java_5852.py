...
Please note that this is a direct translation of the Java code to Python, and it may not work as expected without further modifications. The `runSwing` method in the original Java code has been removed because Swing is not available in standard Python.