...
Please note that the above Python code does not exactly replicate the Java code. The original Java code seems to be a part of some larger program, and this translation is more like an interpretation rather than a direct conversion.