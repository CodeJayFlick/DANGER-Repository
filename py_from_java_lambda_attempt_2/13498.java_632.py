...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The code assumes that `tool`, `program`, `addrSet`, `TaskMonitor.DUMMY` are defined elsewhere in your program.