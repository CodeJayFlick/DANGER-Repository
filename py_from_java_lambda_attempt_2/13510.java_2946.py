...
Please note that this is a direct translation of the given Java code into equivalent Python. It may not be perfect and might require some adjustments to work correctly in your specific environment.