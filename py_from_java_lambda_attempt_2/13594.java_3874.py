...
Please note that the Python version of this code is not exactly equivalent to the Java original. The translation was done based on my understanding of what you wanted me to do with your provided code.