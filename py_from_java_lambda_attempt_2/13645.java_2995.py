...
Please note that this Python code is a direct translation of your Java code and might not work perfectly without some adjustments to fit into your specific use case.