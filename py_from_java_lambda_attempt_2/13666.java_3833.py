...
Please note that Python's `bytearray` is used instead of Java's byte array. Also, some parts like error handling and exception throwing are different in Python compared to Java.