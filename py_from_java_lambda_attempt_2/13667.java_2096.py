...
Please note that Python's `int.from_hex` function is used to convert hexadecimal string to integer. Also, the error handling in the original Java code has been simplified and modified according to Python's exception handling mechanism.