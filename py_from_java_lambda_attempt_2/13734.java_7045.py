...
Please note that this Python code is a simple translation of the given Java code and may not be exactly equivalent. For example, it does not include any kind of error handling or exception management like the original Java code has.