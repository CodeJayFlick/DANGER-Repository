...
```
Note that I had to make some assumptions about the `Slf4j` annotation, as it is not directly translatable to Python. In this implementation, I used the built-in `logging` module instead.

Also, I did not implement a separate logging class like in Java; instead, I used the standard `logging` module and its functions (e.g., `info`, `error`) to log messages.

The rest of the code is translated from Java to Python using equivalent syntax and concepts.