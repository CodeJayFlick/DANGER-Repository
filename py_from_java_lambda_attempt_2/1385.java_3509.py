...
Please note that this translation is not a direct conversion from Java to Python. Some changes were made to the code structure and syntax to make it more idiomatic in Python.