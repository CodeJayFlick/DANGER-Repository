...
Note: The above Python code is not exactly equivalent to the given Java code. It's just a translation of the provided Java code into Python, without considering any potential issues or improvements that might be necessary for it to work correctly in a real-world scenario.