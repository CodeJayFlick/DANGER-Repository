...
Note: Python does not have direct equivalent of Java's `@BeforeEach`, so I used a class method to set up the test. Also, Python does not support static methods directly like in Java, but we can achieve similar functionality using classmethods or instance methods with some adjustments.