...
Please note that Python does not have direct equivalent of Java's `@Slf4j` annotation. In this translation, I used the built-in logging module to achieve similar functionality.