...
Note that Python does not have direct equivalent of Java's abstract class. However, we can achieve similar functionality by defining an abstract method in a base class and making any subclass to implement this method.