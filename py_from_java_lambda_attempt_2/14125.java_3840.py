...
Please note that the above Python code is a direct translation of your given Java code. It may not be optimal or idiomatic in terms of Python coding style, but it should work as expected.