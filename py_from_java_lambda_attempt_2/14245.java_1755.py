...
Please note that Python does not have direct equivalent of Java's `@ToString`, `@EqualsAndHashCode` and `@RequiredArgsConstructor`. These are Lombok annotations which automatically generate boilerplate code. In the above translation, I've omitted these as they do not directly translate to Python.