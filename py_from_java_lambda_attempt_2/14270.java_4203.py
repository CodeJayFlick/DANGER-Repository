...
Please note that this is a direct translation of the Java code to Python and might not be exactly equivalent. For example, in Java you have classes like `MenuItem`, `Dispatcher` etc., which are just simple data holders or utility functions. In Python, these could be replaced with more complex objects if needed.