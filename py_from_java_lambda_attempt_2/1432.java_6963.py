...
Please note that this is a simplified translation and does not cover all the edge cases. You may need to add more functionality based on your specific requirements.