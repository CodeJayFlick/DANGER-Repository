...
Note: Python does not support direct access to private fields like Java. The code above assumes that the `message_queue` field is accessible and modifies it directly.