...
Note that Python does not have a direct equivalent to Java's `@Test` annotation. Instead, we use the name of the function as an indication that it is a test case.