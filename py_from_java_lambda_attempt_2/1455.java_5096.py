...
Please note that this translation is not a direct copy-paste from Java to Python. The code has been modified and adapted for better readability and compatibility with Python syntax.