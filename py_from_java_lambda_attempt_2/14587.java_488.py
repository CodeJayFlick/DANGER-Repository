...
Please note that Python does not have a direct equivalent to Java's enum. The above code uses classes with singletons implemented using the `__new__` method, which is similar in spirit to how enums work in Java.