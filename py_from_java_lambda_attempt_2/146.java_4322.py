...
Please note that Python does not have direct equivalent of Java's SwingUtilities and XML parsing libraries. The code has been adapted to use the built-in `xml.etree.ElementTree` module for XML parsing and threading library for asynchronous execution.