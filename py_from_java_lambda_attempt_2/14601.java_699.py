...
Please note that Python does not have direct equivalent of Java's annotations, so I've removed them. Also, the `@DomainService` and `@NatureOfService` are replaced with regular method calls in the provided translation.