...
Note: The `Video` class is used to represent a video with its attributes. The `FieldJsonMapper` class provides the functionality for mapping specific fields of a video into JSON format.