...
Please note that Python does not have direct equivalent of Java's `@Slf4j` annotation. Also, the logging mechanism is different between Java and Python. In this translation, I used Python's built-in print function to simulate the log messages.