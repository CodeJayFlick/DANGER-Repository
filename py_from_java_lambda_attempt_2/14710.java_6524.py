...
Please note that Python's tkinter library is used to create the GUI. Also, I have made some assumptions about how you want your code structured and what classes you might need for certain functionality.