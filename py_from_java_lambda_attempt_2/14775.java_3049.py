...
Please note that I've used Python's built-in `unittest` module for testing. The equivalent of Java's JUnit Jupiter is not available as a direct translation.