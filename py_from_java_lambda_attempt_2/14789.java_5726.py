...
Note that the Python code does not include all of the Java-specific details (like exception handling and synchronization), as these are handled differently in Python.