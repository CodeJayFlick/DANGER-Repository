...
Note: The `DummyProc` class is not present in the given Java code, so I did not include it here. Also, some variables and methods have been renamed to match Python's syntax and naming conventions.