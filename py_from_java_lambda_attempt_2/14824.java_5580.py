...
Note that Python does not have direct equivalent of Java's `@BeforeEach` and `@AfterEach`. Instead, we use the `setUpClass` and `tearDownClass` methods to set up and tear down our test class.