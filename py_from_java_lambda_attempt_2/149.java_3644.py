...
Please note that this is a simplified translation and does not include all the functionality of the original Java code. The `create_actions` method, for example, has been left empty in the Python version.