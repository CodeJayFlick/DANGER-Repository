...
Please note that this is a direct translation of the given Java code into Python. It may not be perfect, as there might be some differences in how certain operations are handled between the two languages.