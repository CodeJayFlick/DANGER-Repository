...
Please note that Python does not have direct equivalent of Java's `@BeforeAll` and `@BeforeEach`. Instead, you can use the `setUp()` method which is called before each test.