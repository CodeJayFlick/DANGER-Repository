...
Note that Python does not have direct equivalent of Java's `package` declaration, so I omitted it in the translation. Also, Python uses indentation to denote block-level structure instead of curly braces like Java.