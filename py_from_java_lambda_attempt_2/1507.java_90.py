...
This Python code is a direct translation of the provided Java code. It includes all the methods and classes from the original code with equivalent functionality in Python.