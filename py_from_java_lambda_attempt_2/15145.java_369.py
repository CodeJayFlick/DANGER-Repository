...
Please note that Python does not have direct equivalent of Java's `@Slf4j` annotation. Instead, we use the built-in logging module to log messages in this example.