...
Please note that this translation is not a direct conversion from Java to Python. The code structure has been modified slightly for better readability in the context of Python programming.

The `AbstractWalletActivityViewModel` class, which seems to be an interface or abstract class in Java, does not have a direct equivalent in Python. It might need further modification depending on its actual functionality and usage within your program.