...
Please note that Python's `Path` class is used to represent file paths, and the `re` module provides support for regular expressions. The code also uses type hints for better readability and static analysis tools like mypy.