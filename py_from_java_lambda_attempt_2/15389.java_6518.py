...
Please note that the above Python code is a direct translation of your Java code. It might need some adjustments based on how you plan to use it in your actual application.

Also, I used PIL (Python Imaging Library) for handling images and numpy for array operations.