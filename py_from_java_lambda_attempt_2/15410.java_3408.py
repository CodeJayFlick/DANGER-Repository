...
Note that the `NDArray` class is not a built-in Python type. It seems to be a custom data structure used in this code for representing arrays of numbers with shape information.