...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation and might require some adjustments based on the actual usage scenario.