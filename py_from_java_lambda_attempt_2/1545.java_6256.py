...
Please note that the above Python code is a direct translation from Java to Python. However, it may not work as expected without proper implementations for `get_current_session`, `do_breakpoint_enabled` and `get_known_breakpoints`. These methods are placeholders in the given Python code and should be replaced with actual implementation based on your specific requirements.