...
Please note that this translation assumes you have a TranslatorContext class defined elsewhere in the codebase. Also, replace `Your_Translator_Instance` with your actual translator instance.