...
Please note that this is a direct translation of the given Java code into Python. The original Java code seems to be part of some larger framework or library, and may not work as-is in a standalone Python environment.