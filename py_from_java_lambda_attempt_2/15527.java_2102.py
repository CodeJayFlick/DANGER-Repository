...
Note that this translation is not a direct copy-paste from Java to Python. The code has been adapted for the differences in syntax between the two languages.