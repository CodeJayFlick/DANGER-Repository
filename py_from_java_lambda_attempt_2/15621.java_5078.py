...
This Python code is equivalent to your Java code, but note that I've used some assumptions and simplifications based on my understanding of your original code.