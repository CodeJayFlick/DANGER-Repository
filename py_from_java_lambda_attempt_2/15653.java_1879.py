...
Please note that the translation is not a direct copy-paste of Java code into Python. The logic and functionality are preserved but some minor adjustments were made to fit Python's syntax and semantics.