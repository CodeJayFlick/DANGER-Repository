Here is the translation of the Java interface `HpOptimizer` into a Python class:
...
Note that the `Pair` class from Java does not exist in Python. Instead, we use a tuple to represent pairs of values.