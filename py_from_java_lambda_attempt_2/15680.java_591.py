...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation and may require some adjustments based on the specific requirements of your project.