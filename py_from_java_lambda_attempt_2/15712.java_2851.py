...
Please note that Python does not have an exact equivalent to Java's `@Override` annotation. The method overriding is done by the name and signature of the methods, so you don't need to explicitly declare it in Python.