...
Please note that Python does not have direct equivalent of Java's `Properties` class. We are using a dictionary to store the properties in this translation.