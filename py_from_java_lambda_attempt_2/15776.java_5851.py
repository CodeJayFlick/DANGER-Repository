...
if __name__ == "__main__":
    unittest.main()
```
Note that I assumed the `SimpleTokenizer` class is defined elsewhere and has methods `tokenize()` and `build_sentence()`. If you need help defining this class in Python, please let me know!