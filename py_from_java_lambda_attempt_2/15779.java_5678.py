...
Please note that the above Python code is a direct translation of your Java code and may not work as expected. You will need to implement the logic for `SimpleTokenizer.tokenize`, `SimpleTokenizer.build_sentence` and `UnicodeNormalizer.preprocess`.