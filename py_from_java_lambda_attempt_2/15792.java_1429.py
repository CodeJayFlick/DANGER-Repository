...
Note: This translation is not a direct conversion from Java to Python. It's more of an equivalent implementation in Python. The original code has some complex logic and might require additional modifications or simplifications for it to work correctly in the target language.