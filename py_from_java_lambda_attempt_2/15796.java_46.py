...
Note that I've used the `Shape` class as a tuple in Python. The Java equivalent of this is not provided in your code snippet, so I assumed it to be just an immutable collection of values.