...
Please note that the above Python code is a direct translation of the given Java code and may require some modifications to work correctly in your specific use case.