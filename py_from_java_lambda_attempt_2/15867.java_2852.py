...
Note that this is a direct translation of the Java code to Python. The `@Test` annotation in Java does not have an equivalent in Python, so I used the built-in testing framework provided by Python's `unittest` module instead.