...
Please note that this translation does not include the `DataType` class and its methods (`parse_data_types`, `append_type_name`, etc.) as they are specific to your Java code.