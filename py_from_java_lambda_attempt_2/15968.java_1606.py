...
Please note that this is a direct translation of the given Java code into Python. It may require some adjustments to work correctly in your specific use case, as it does not include any error handling for cases where `model_path` might be an absolute path or if there are multiple `.onnx` files with different prefixes.