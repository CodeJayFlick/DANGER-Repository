...
Note that Python does not have an equivalent to Java's `private` access modifier. In Python, variables and methods are public by default unless they start with a single underscore (`_`) or two underscores (`__`).