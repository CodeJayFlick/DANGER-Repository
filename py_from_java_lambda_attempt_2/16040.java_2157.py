...
Please note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. The original code may have some specific requirements or constraints that are not easily translatable into Python.