...
if __name__ == "__main__":
    main()
```
Note that I've kept the same variable names and structure as the original Java code, but translated them to Python. Some changes were necessary due to differences in syntax and semantics between the two languages.

Also note that this is a direct translation of the Java code, without any optimization or refactoring for Python-specific best practices.