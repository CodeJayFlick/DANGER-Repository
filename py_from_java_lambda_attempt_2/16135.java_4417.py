...
Note that the code is not a direct translation of Java to Python. It's more like an adaptation, as some parts don't have exact equivalents in Python (like `Criteria` and `DetectedObjects`).