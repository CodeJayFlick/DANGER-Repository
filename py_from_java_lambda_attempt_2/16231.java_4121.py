...
```
Note that I've used the `urllib.parse` module to parse the URI in Python, and created a separate class for the HDFS repository. The rest of the code is similar to the original Java implementation.