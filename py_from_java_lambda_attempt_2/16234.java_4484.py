...
Please note that this code is not a direct translation of the Java code. It's more like an equivalent Python implementation with some simplifications and adjustments to work in the Python environment.