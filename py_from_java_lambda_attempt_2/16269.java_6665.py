...
Please note that this code is not a direct translation of the given Java code. It's more like an equivalent Python implementation with some adjustments to fit into Python syntax and semantics.