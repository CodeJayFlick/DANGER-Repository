...
Please note that this is a direct translation of the given Java code into Python. It might not be perfect, as some parts may need adjustments based on your specific use case and requirements.