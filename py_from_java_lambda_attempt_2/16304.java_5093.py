...
Note: This code is a direct translation of the Java code into Python. However, it may not work as expected because some parts of the original code are missing in this translation (like NDManager and Batchifier classes).