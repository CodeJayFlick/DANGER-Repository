...
Please note that this code is not a direct translation of the Java code, but rather an equivalent Python implementation. The original Java code may have some specific features or libraries that are not directly translatable to Python.