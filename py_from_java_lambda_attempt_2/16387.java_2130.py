...
Please note that Python does not support the same level of encapsulation as Java, so I have removed some of the Java-style comments and reorganized the code slightly to make it more readable.