...
Note that Python does not have direct equivalents of Java's `@Nullable` annotation or the JUnit assertion methods. Also, Python's file handling is different from Java's, so I had to adjust the code accordingly.