...
Note that Python does not have direct equivalents for Java's `package`, `import` statements, or the `@Override` annotation. The code is written in a way that it can be used as-is with Python.