...
Please note that the Python code is not a direct translation of Java, but rather an equivalent implementation. The logic and functionality are preserved, but some differences in syntax and structure may exist due to the nature of the two languages.