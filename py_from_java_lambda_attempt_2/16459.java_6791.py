...
Please note that this is a direct translation of your Java code into Python. It may not be the most idiomatic or efficient way to write the same logic in Python.