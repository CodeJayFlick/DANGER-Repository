...
Note that Python does not have an exact equivalent to Java's enum class. However, we can achieve similar functionality using a class with static variables and no instance methods (as shown above).