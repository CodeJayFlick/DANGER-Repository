...
Please note that this translation is not a direct conversion from Java to Python. The code has been modified and simplified according to the best practices of Python programming.

Also, please be aware that some parts of the original Java code are missing in this Python version because they were not provided or could not be translated directly (e.g., `get_test_measurement_mnode`, `get_test_measurement_schema`).