...
Please note that you need to implement all the methods in Python. The above code is just a translation from Java and does not include any actual implementation.