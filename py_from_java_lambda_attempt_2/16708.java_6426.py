...
Please note that this is a translation of the Java code to Python, and it may not be exactly equivalent. The original Java code might have some specific functionality or edge cases that are not fully captured in this Python version.