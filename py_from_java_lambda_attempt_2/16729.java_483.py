...
Please note that this is a direct translation of the Java code into Python. It might not be perfect, and you may need to adjust it according to your specific requirements or environment.