...
Please note that the Python version of your Java code is not a direct translation. The provided code has been modified to work with Python's csv module and its own data structures (like lists).