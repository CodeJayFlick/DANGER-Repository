...
Please note that Python does not support the concept of a static class like Java. The equivalent would be to define these constants as global variables or inside a function if you don't want them to pollute your namespace.