...
```
Note that I did not implement the `query_series` and `get_meta_data` methods as they were in the original Java code. Instead, I raised a `NotImplementedError`. You would need to implement these methods according to your specific requirements.

Also, I used Python's built-in `datetime` module for working with dates and times.