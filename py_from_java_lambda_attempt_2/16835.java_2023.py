...
Please note that this is a translation of the Java code to Python. The actual functionality may vary depending on how you implement it in your specific use case.