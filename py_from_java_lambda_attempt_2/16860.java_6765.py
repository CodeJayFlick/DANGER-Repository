...
Note that I've left the `MetaManager` class and its methods as placeholders, since you didn't provide any implementation for them. You'll need to fill in the blanks with your own code.