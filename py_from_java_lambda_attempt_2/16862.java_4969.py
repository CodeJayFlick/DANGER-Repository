...
Please note that Python does not have direct equivalent of Java's `TSDataType` and `SessionPoint`. I've replaced them with strings. Also, the code assumes that the session object has attributes like 'default_end_point', 'username' and 'password'. If these are not present in your actual session objects, you may need to modify this code accordingly.