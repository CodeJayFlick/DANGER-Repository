...
Please note that the Java code has been translated into Python, but some parts of it (like `AuthUtils`, `SerializeUtils`) are not present in this translation. You would need to implement these classes or functions yourself based on your specific requirements.

Also, please be aware that there might be slight differences between the original Java code and its Python equivalent due to language-specific features and nuances.