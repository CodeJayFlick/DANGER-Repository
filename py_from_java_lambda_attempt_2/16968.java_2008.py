...
Please note that Python does not have direct equivalent of Java's `BufferedWriter` and `FileWriter`. Instead, we use the built-in file handling functions to achieve similar functionality.