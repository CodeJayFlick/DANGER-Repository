...
Note that I've used Python's built-in `logging` module for logging, and also converted the Java code to use Python's property decorator (`@property`) instead of getter/setter methods.