...
class TsFileManagerConstant:
    ...
    FILE_NAME_SEPARATOR = "-"
```
Note that I've used the `@property` decorator to define getter and setter methods for some of the attributes, as well as the `@classmethod` decorator to define a class method. Additionally, I've replaced the Java-style comments with Python-style docstrings.

Also, please note that this is just one possible translation of the code from Java to Python, and there may be other ways to achieve the same result.