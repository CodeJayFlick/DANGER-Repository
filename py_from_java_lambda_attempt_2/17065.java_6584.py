...
Please note that the above Python code is a direct translation of your Java code. It may not be perfect, as some parts might need to be adjusted based on how you want them to behave in Python.