...
Note that Python does not have a direct equivalent to Java's `serialVersionUID`. Also, I've used the `@property` decorator in Python to create getter and setter methods for your attributes.