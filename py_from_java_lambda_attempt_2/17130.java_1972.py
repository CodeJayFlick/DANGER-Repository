...
Note that Python does not have an exact equivalent to Java's `enum` keyword. Instead, we define a class with static attributes representing the different values of the enum.