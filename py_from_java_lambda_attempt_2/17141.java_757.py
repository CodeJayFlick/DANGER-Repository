...
Please note that Python does not have direct equivalent of Java's `AtomicInteger` class. In the above code, I used a simple integer to simulate the behavior of an atomic integer.

Also, please be aware that this is just one possible translation and there might be other ways to translate the same code into Python.