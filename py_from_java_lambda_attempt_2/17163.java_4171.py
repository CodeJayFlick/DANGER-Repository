...
Note that this translation is not a direct copy-paste from Java to Python, but rather an equivalent implementation in Python. The `IMNode`, `PartialPath` classes and their methods are abstracted out as they seem to be part of the IoTDB library which you would need to implement separately for your specific use case.