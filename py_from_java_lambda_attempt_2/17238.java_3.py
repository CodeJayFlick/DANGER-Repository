...
Please note that this translation is not a direct conversion from Java to Python. The code has been rewritten in a way that takes advantage of the unique features and best practices of the Python language, while still maintaining the original functionality.