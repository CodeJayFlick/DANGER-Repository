...
Note that this translation is not a direct copy-paste from Java to Python. Some modifications were made to make it more idiomatic and efficient in Python.