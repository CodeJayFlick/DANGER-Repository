...
Please note that this is a direct translation of the Java code into Python. You may need to adjust it according to your specific requirements and use cases.

Also, please be aware that some methods in the original Java code are not implemented here (e.g., `checkIntegrity`, `getPaths`, etc.).