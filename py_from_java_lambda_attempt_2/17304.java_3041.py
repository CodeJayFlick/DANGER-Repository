...
Note that this translation is not a direct equivalent of the Java code, but rather an adaptation to Python. Some changes were made to fit Python's syntax and semantics.