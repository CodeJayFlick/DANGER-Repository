...
```
Note that I've used the `io` module for working with file streams, and the `bytes` type to represent binary data. The rest of the code is straightforward translation from Java to Python.

Also, please note that this is a direct translation, without any modifications or optimizations specific to Python.