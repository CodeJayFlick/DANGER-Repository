...
Please note that I've used Python's type hinting for clarity, but it doesn't affect the functionality. Also, `IoTDB`, `ConcatPathOptimizer` and other classes are not defined in this code snippet as they seem to be custom classes specific to your project.