...
Note that Python does not have direct equivalents for Java's `@Override`, `@property` and `@setter`. The equivalent functionality is achieved using the built-in property decorator.