...
Please note that I have not implemented the `SingleInputColumnSingleReferenceIntermediateLayer` and `SingleInputColumnMultiReferenceIntermediateLayer` classes as they seem to be part of a larger system.