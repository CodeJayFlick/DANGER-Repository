...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The `BytesUtils` class used in the original Java code does not exist in Python by default, so you would need to implement your own equivalent or use an existing library if needed.