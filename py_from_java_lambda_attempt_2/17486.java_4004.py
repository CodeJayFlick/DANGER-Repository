...
Note that this translation assumes the existence of certain methods (`has_next_file`, `current_file_statistics`, etc.) which are specific to your implementation and may need additional code.