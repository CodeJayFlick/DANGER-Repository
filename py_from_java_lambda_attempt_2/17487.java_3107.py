...
Please note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. The original code may have some specific features or optimizations that are difficult to translate directly into Python.