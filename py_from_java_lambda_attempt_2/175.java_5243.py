...
Please note that I've made some assumptions about the `PcodeProgram` class and its methods, as they were not provided in the original code. You'll need to implement these yourself based on your specific requirements.