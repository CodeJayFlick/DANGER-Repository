...
Note that I've used Python's type hinting to specify the types of variables and function parameters. This is not strictly necessary, but it can be helpful for documentation purposes and also helps catch some errors at runtime.