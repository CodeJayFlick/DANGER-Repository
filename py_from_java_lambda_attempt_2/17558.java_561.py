...
Note that this translation is not a direct conversion from Java to Python, but rather an equivalent representation in Python. Some methods and classes may have different implementations or behaviors compared to their Java counterparts due to differences between the two languages.