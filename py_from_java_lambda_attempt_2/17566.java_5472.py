...
Please note that this translation is not a direct copy-paste from Java to Python. It's more like rewriting the code in Python, as there are some differences between the two languages.