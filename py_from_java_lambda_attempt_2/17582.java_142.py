...
Note that the Java code has some specific characteristics (like static inner classes and final methods) which are not directly translatable to Python. In this translation, I've kept the same structure as the original Java code but with Python syntax.