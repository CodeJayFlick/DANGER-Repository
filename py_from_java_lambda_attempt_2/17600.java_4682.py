...
Please note that Python does not support exact equivalent of Java's `@Override` annotation and also the concept of static methods in Python is different from Java.