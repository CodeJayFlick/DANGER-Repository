...
Note that this translation is not a direct conversion, but rather an equivalent Python code. Some Java-specific constructs like `static` methods and variables are translated into Python's class-level attributes or instance methods. The logic of the original code remains intact.

Also note that some parts of the original code (like the `main` method) have been removed as they do not directly translate to Python syntax.