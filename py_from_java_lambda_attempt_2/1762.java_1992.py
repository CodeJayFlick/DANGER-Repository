...
Please note that Python does not have direct equivalent of Java's `public`, `private` and other access modifiers. In this code, I've used the conventional naming convention for public (`_`) and private (`__`) attributes in Python.