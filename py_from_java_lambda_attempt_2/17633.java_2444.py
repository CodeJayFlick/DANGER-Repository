...
Note that I used the `logging` module for logging and `os.environ.get()` to get environment variables. The rest of the code is similar to the Java version with some minor adjustments due to Python's syntax differences.