...
Note: The `SyncSenderLogger` class is missing in the provided Java code. It seems to be a custom logger that provides some constants and methods for logging purposes. In Python, you can replace this with your own implementation of a logger or use an existing one like `logging`.