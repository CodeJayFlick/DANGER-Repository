...
Please note that Python does not have direct equivalent of Java's `Logger` and `SystemCheckException`. I used the built-in logging module in Python to simulate these.