...
Note that Python does not have a direct equivalent to Java's `TSDataType` or `QueryProcessException`. I've replaced these with simple string types and exceptions, respectively.