...
```
Note that I've used Python's built-in `int` type instead of Java's `long`, and removed some unnecessary code. Additionally, I've replaced Java's `ArrayList` with a simple list comprehension in the constructor.

Also, please note that this is not a direct translation from Java to Python, but rather an adaptation of the original code to work with Python's syntax and semantics.