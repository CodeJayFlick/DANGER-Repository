...
```
Note that I used a `defaultdict` from the `collections` module to implement the cache as an unordered dictionary. This is equivalent to Java's `ConcurrentHashMap`.