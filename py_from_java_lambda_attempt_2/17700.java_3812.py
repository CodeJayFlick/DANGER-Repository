...
Note that Python does not have direct equivalent of Java's `TSDataType` enum. In the above code, I've used string constants for representing different data types in Python.