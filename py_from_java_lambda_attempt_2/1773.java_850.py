...
Please note that Python does not have direct equivalent of Java's `public` and `private`. The `_values`, `_value_to_name`, `_name_to_value` are intended to be private variables.