...
Note: This code is written in Python 3.x. If you are using an earlier version of Python (like Python 2), some parts might not work as expected due to differences between the two versions.