...
```
Note that I've used the `os` module to work with file paths and names. Additionally, I've replaced the Java-specific types (e.g., `Set<String>`) with Python's built-in types (e.g., `set[str]`).