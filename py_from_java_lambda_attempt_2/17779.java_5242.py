...
Note: This Python code is a direct translation of the Java code. It may not be perfect and might require some adjustments to work correctly in your specific environment.