...
Note that the Python code uses ctypes to interact with C functions and objects. The Java code's use of `long` types is replaced by using `ctypes.c_long` in Python.