...
Note that this is a direct translation of the Java code into Python. The logic and functionality remain the same, but some minor adjustments were made to accommodate differences in syntax between the two languages.