...
Note: This Python code is not a direct translation of the Java code. It's more like an equivalent implementation in Python. The actual translation would require understanding how to translate Java concepts into Python (e.g., `transient` fields are not needed in Python, etc.).