...
Please note that this is a translation of the Java code to Python, and it may not work as expected without further modifications. The `create_storage_group_tool` method in particular seems to be missing some logic from the original Java code.