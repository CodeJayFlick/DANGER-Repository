...
Please note that the above Python code is not a direct translation of your Java code. It's more like an equivalent implementation in Python with some modifications to suit Python syntax and semantics.