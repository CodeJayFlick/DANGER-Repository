...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original Java code seems to use some custom classes (`Accumulator`, `Counter`) which are not defined in the provided code snippet.