...
Note: The Python code is written with the assumption that `MetaUtils` and its methods (`split_path_to_detached_path`, `get_multi_full_paths`) are defined elsewhere in your program.