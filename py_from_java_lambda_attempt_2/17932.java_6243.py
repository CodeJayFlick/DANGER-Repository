...
Please note that this is a direct translation of the Java code into Python. The original Java code has some dependencies which are not present in this Python version, such as `IoTDB`, `EnvironmentUtils` etc., these need to be implemented or replaced with equivalent functionality for it to work correctly.