...
Please note that Python does not support static variables like Java. So I have used a dictionary `TSDataType` to simulate the functionality of TSDataType in Java.