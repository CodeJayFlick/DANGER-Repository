...
Note: The `EnvironmentUtils` and `SyncConstant` classes are not defined in the provided Java code, so I did not translate them to Python as they seem to be custom classes specific to your project.