...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original code might have some issues or bugs which are not handled in this translation.