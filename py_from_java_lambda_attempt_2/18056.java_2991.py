...
Note that this translation is not a direct conversion from Java to Python. Some modifications were made to the code structure and syntax to make it more idiomatic in Python.