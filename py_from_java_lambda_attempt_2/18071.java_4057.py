...
class EnvironmentUtils:
    ...
    def prepare_data():
        try:
            ...
            # ... (rest of the code)
```
Note that I've used Python's built-in `logging` module to replace Java's logging functionality, and `File` from the `io` module instead of creating a custom class. Additionally, I've removed some redundant code and reformatted the existing code to conform to PEP 8 style guidelines.

Please note that this is not an exact translation, as Python has different syntax and semantics than Java. This code should be used as a starting point for your own implementation in Python.