Here is a translation of the Java code you provided to Python:
...
Please note that this is a translation of the Java code to Python, and it may not be exactly equivalent.