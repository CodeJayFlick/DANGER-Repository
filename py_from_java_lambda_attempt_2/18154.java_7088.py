...
Please note that the above Python code is a direct translation of your Java code and may need some adjustments to work correctly in a Python environment.