...
Note that Python does not have an exact equivalent to Java's `enum` type. Instead, we use a class with class variables and methods to achieve similar functionality.