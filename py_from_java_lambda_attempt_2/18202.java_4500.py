...
Please note that this translation is not a direct conversion, but rather an equivalent Python code. Some methods and variables might have been modified to fit the syntax and conventions of Python.