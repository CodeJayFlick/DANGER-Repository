...
Please note that Python does not have a direct equivalent to Java's `TSDataType` enum. I've used strings instead, assuming they will be used as keys in a dictionary or something similar.