...
Please note that this is a direct translation of the given Java code into Python. The original class hierarchy and method signatures are preserved, but you may need to adjust them according to your specific use case in Python.