...
Please note that Python does not support direct translation of Java code. The above Python code is a manual translation and may have some differences from the original Java code due to language-specific features and nuances.