...
This Python code is equivalent to the given Java code. It uses the `unittest` module for unit testing and the `BytesIO` class from the `io` module for working with binary data in memory.