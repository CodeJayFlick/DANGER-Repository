...
Please note that the above Python code is a direct translation of your Java code and might not work as-is. You will need to modify it according to your specific requirements, such as changing file paths or handling exceptions differently.