...
Please note that this is a direct translation of the given Java code into Python. The actual implementations for `is_valid`, `is_equal_to`, `get_name`, `get_type`, `is_regex`, and `get_description` methods are missing as they were not provided in the original Java code.