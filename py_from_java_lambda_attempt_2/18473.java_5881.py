...
Please note that this is a translation of the Java code into equivalent Python code. The actual functionality may not be exactly the same due to differences between languages and libraries used.