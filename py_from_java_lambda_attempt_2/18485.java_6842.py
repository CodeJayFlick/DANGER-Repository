...
Please note that the above Python code is not exactly equivalent to the given Java code. The logic of both codes might be different, and some parts may have been simplified or modified for better readability in Python.