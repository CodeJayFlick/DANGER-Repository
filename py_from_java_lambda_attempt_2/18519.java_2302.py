...
Please note that Python does not have direct equivalent of Java's `DateTimeFormatter` and `Clock`. The date formatting in the above code is done using Python's built-in datetime module.