...
Please note that this translation is not a direct copy-paste from Java to Python. The code has been adapted and modified according to the differences between these two programming languages.

In particular, I've used `json` module for JSON operations instead of Jackson library in Java.