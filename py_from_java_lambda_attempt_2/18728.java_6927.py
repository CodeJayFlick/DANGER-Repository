...
Note that this code does not include the equivalent of Java's `@Override` annotation. In Python, you don't need such an annotation because method overriding is done using the same name as the parent class method.