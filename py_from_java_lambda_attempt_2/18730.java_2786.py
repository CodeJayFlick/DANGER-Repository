...
print(pet2.name)  # prints: Fifi
print(pet2.date_of_birth)  # prints: 2015-06-15

```

Note that Python does not have a direct equivalent to Java's `Date` class. Instead, we use the built-in `datetime` module and its `date` class to represent dates in ISO format (YYYY-MM-DD).