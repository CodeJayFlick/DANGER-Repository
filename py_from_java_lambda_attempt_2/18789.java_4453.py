...
```
Note that I've used Python's built-in `abc` module for abstract classes, and created equivalent classes in Python (e.g., `ImmutableOperations`, `Operation`). The rest of the code is a direct translation from Java to Python.