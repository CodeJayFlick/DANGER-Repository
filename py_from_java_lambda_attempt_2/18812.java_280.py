...
Note: This is a direct translation of the Java code into Python. However, please note that some parts might not work as expected due to differences in language syntax and libraries used.