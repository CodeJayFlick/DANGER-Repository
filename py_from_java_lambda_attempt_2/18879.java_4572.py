...
Please note that Python does not have direct equivalent of Java's `@Observes` and `BeanManager`. The provided translation is a best-effort attempt to translate the code into Python.