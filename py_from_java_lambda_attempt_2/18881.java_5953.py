...
Please note that this is a direct translation of the Java code into Python. The equivalent Python classes and functions are provided as-is without any modification or optimization for performance.