...
Please note that the Python code does not directly translate from Java. The equivalent functionality is implemented in a different way, and some parts might be missing or simplified for simplicity.