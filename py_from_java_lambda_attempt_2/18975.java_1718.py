...
Please note that Python does not have direct equivalent of Java's `@Provider` annotation. Also, Python does not support method overriding like Java does with the `@Override` annotation.