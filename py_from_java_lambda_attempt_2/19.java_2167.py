...
Please note that Python does not support direct translation of Java code into equivalent Python. The above code is a manual translation and may require some adjustments based on the actual usage in your program.