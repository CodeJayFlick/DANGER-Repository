...
Please note that Python does not have direct equivalent of Java's `@Value.Immutable` and `package org. projectnessie.versioned.persist.dynamodb;`. The above code is a simple translation into Python, without any specific annotations or packages.