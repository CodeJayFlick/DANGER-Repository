...
```
Note that I did not translate the entire Java code to Python, as some parts (like `PostgresDatabaseAdapterFactory` and `JdbcDatabaseContainer`) are not directly translatable or require additional libraries.