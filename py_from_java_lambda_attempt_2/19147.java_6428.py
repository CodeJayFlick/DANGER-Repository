...
Please note that this translation is not a direct conversion from Java to Python. The code has been modified slightly to fit the conventions and syntax of Python.