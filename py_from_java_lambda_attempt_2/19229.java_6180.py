...
Please note that this translation does not include all classes and methods from the original Java code. It only includes the `CondDamageCause` class which seems to be the main part of your condition checking mechanism.