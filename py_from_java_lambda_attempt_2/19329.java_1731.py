...
Please note that Python does not support direct translation of Java code. The above Python code is a manual conversion and may have some differences in functionality or syntax compared to the original Java code.