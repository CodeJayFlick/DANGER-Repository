...
Please note that Python does not support Java-like syntax and annotations. The equivalent functionality is achieved using properties, setters, and type hints in the given code.