...
Note that this translation assumes the existence of certain classes and methods (`Skript`, `PassengerUtils`, etc.) which are not defined in the provided Java code.