...
Note that this is a direct translation of the given Java code into Python. It may not be perfect, as some parts might need adjustments based on how you want to use them in your actual program.