...
Note that Python does not have direct equivalents for Java's `@Override`, `static` blocks, and some of the annotations. Also, Python is dynamically typed so it doesn't need explicit type declarations like in Java.