...
Please note that Python does not have direct equivalent of Java's static block or enum. Also, the code is translated as much as possible to match the original functionality and structure in Python.