...
Please note that this is a direct translation of the given Java code into Python, without any modifications or improvements to make it more idiomatic or efficient in terms of Python.