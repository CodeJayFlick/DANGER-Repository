...
Please note that this is a translation of Java code into Python and may not be exact. The `@Name`, `@Description`, `@Examples` annotations are specific to JavaDoc, which has no direct equivalent in Python.