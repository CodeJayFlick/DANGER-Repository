...
This Python code is a direct translation of the given Java code. Note that some parts might need to be adjusted according to your specific use case or requirements.