...
Please note that this translation assumes the existence of certain classes and methods (`LiteralUtils`, `CollectionUtils`, etc.) which are not defined in your original Java code.