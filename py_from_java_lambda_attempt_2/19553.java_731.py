...
Please note that this translation does not include all classes and methods from the original Java code. It only includes those parts which are directly related to the `ExprEntityTamer` class.