...
Please note that Python does not have direct equivalent to Java's `@Name`, `@Description`, etc., annotations. These are used for documentation purposes and can be achieved through docstrings or comments in the code.