...
Please note that this translation is not a direct conversion from the given code, but rather an equivalent Python implementation. The actual functionality may vary depending on how you use these classes in your program.