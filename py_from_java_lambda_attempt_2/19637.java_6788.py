...
Note that Python does not have direct equivalents for Java's static blocks or annotations. The `register_expression` method is simply a regular instance method in the Python version.