...
Please note that Python does not have a direct equivalent to Java's `@Name`, `@Description`, etc. annotations. The docstrings are used instead for documentation purposes.

Also, the given code seems to be part of a larger system (Skript) and might require additional setup or imports in order to work correctly.