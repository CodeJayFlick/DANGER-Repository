...
Please note that this is a translation of the interface and does not include any actual implementation. The methods are declared as they were in Java, but without their original functionality.