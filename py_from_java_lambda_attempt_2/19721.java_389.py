...
Please note that this translation doesn't cover every detail of the original Java code. For example, it doesn't include any equivalent for the `@Name`, `@Description`, `@Examples` and `@Since` annotations as these are not directly translatable to Python.