...
Please note that Python does not have direct equivalent of Java's `@Override`, `@Name`, `@Description` etc. annotations, so these were removed in the translation process.