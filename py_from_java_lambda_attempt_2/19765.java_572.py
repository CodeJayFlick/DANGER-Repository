...
Please note that Python does not have direct equivalent of Java's annotations, so I removed them in the translation. Also, Python does not support static methods or blocks like Java does.