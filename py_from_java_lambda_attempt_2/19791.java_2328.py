...
Please note that Python does not have direct equivalent of Java's `@Override`, `@Nullable` and other annotations. Also, the concept of generic types in Java is handled differently in Python (using type hints).