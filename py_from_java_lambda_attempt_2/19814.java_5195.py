...
Please note that I've made some assumptions about the code, especially in `walk` and `remove_locals`, since they seem to be related to Skript's internal workings.