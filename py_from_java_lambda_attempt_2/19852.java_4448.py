...
Please note that Python does not have direct equivalent of Java's `@Nullable` annotation or the concept of static methods. Also, error handling is different in both languages.