...
Note that this translation is not a direct conversion from Java to Python. Some parts have been modified or rewritten for better fit with the Python syntax and style.