...
Note that this is a direct translation of the Java code to Python, and it may not be perfect. The original Java code seems to have some issues with formatting and naming conventions, which I tried my best to maintain in the translated Python code.