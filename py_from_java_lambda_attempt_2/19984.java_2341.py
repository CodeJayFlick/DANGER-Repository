...
Please note that Python does not have direct equivalent of Java's `Iterator` and `NoSuchElementException`. We use the built-in iterator protocol (`__iter__`, `__next__`) to implement our own iteration.