...
Please note that this is a translation of the Java code into equivalent Python. It may not be exactly identical to the original Java code due to differences between languages and their respective syntaxes.