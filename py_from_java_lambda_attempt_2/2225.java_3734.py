...
Please note that the `PathUtils` class is not fully implemented in this translation. You will need to implement its methods according to your specific requirements.