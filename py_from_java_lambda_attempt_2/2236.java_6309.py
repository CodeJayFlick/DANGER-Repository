...
Please note that Python does not have direct equivalent of Java's `CompletableFuture` and `Consumer`. The above code uses Python's built-in support for asynchronous programming using the `fut.as_completed()` function.