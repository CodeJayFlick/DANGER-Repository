...
Note that the Python code does not have direct equivalent of Java's `@TargetObjectSchemaInfo` and other annotations. Instead, we use abstract methods to define the schema information.