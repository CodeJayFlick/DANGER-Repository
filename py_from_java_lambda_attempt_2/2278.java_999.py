...
Please note that the above Python code is a direct translation of your given Java code. It might not be perfect and may require some adjustments based on how you plan to use it in your actual project.