...
Note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. Some methods and variables have been renamed or reorganized for better fit with the Python syntax and conventions.