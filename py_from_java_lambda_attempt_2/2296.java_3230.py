...
Please note that this is a direct translation of the Java code into Python, and it might not work as expected without proper implementation. The `wait_acc`, `retry_for_process_running` methods are placeholders for actual implementations in your program.