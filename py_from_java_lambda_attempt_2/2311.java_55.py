...
Please note that Python does not support the exact equivalent of Java's `abstract class` or `interface`. Instead, you can use a regular class and define abstract methods.