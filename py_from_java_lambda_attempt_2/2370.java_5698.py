...
Note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. The code has been rewritten to take advantage of Python's syntax and features, while maintaining the same functionality as the original Java code.