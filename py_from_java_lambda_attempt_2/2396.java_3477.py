...
Note that this is a direct translation of the Java code into Python. The equivalent functionality may be achieved with different syntax and structure in Python compared to Java.