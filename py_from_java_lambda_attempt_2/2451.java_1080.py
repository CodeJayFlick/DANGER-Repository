...
Please note that Python does not have direct equivalent of Java's annotations. The `@` symbol is used for decorators in Python, which are a different concept from Java's annotations.