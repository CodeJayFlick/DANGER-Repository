...
Please note that this is a direct translation of the Java code into Python. The resulting Python code may not be perfect or idiomatic Python due to the complexity and nuances of translating from one language to another.