...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, the translation is based on my understanding and might require further adjustments to work correctly in a real-world scenario.

Also, I used type hints for clarity but they are not enforced by Python at runtime.