...
Please note that the given Java code seems to be part of a larger system and might require additional classes or methods not provided in this translation.