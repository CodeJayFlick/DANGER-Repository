...
Note: This translation is not a direct copy-paste from Java to Python. It's more of an equivalent implementation in Python, considering the differences between both languages and their respective libraries.