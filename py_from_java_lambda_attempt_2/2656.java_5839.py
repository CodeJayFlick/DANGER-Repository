...
Please note that Python does not support direct translation of Java code. The above code is a manual translation from the provided Java code to equivalent Python code, and it may require some adjustments based on your specific requirements.