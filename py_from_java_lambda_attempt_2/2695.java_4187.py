...
Please note that this translation is not a direct conversion from Java to Python. It's more of an equivalent implementation using Python's built-in data types and modules (like tkinter for GUI).