...
Please note that this is a direct translation of the Java code into Python. The actual implementation may vary based on how you want to use these classes in your own program.