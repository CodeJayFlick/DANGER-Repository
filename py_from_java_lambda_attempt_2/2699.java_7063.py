...
Please note that Python does not have direct equivalent of Java's `Range` class. Also, the code assumes a GUI framework like Tkinter or PyQt for creating graphical elements such as tables and mouse events.