...
Please note that this translation is not exact, as Python and Java are different languages. Some parts of the code may have been modified or omitted to make it compatible with Python.