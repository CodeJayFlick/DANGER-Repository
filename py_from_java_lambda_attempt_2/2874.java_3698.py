...
Note: The `add_plugin` function and the classes `AnnotatedServicesProvidedPlugin`, `DummyPlugin`, `AnnotatedServicesConsumedByFieldComponent`, and `AnnotatedServicesConsumedByMethodComponent` are not implemented in this translation.