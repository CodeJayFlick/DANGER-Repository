...
Please note that this translation is done manually and may contain errors. Also, Python does not support direct translation of Java code as it has different syntax and structure.