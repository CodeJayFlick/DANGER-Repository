...
Please note that this translation is not perfect and may require some adjustments to work correctly. The code might need additional error handling or modifications based on the specific requirements of your project.