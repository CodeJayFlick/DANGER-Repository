...
Please note that the `ask_yes_no` function is a simple implementation and might not work exactly as you would expect in all situations, especially if you're running this script from an interactive shell like IDLE.