...
Please note that the above code is a direct translation of Java to Python and may not be exactly equivalent in terms of functionality. The classes `PropertyBoolean`, `PropertySelector` and `PropertyText` are assumed to exist in Python as they were present in the original Java code.