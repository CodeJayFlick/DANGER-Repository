...
Please note that you need to implement the `get_current_analysis_options_and_values`, `set_analysis_options`, and `reset_all_analysis_options` methods in your Python code.