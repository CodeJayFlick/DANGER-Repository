...
Please note that you need to implement `get_first_function`, `get_last_function`, `get_function_after` and `get_function_before` methods in your Python script. These methods are not implemented here as they depend on how you want to iterate over functions in your program.