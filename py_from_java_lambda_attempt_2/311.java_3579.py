...
Note that Python does not have direct equivalents for Java's `@Override` annotation or the `@DebuggerBotInfo` class. Also, some of the code has been simplified and modified to fit Python's syntax and conventions.