...
Please note that this is a direct translation of the given Java code into Python. The `ask_project_folder`, `confirm_delete` and other functions are not defined in the provided Java code, so I left them as they were.