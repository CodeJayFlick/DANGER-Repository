...
Note that Python does not have direct equivalent of Java's `public` and `private`. In Python, everything is public by default. If you want to make a variable or method private in Python, you can use double underscore prefix (`__`) which makes it inaccessible from outside the class (but still accessible within the same class).