...
Please note that this is not an exact translation, as Python does not have direct equivalents for Java's classes and methods. The code above provides the same functionality in a different way.