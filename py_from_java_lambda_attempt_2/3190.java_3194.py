...
Please note that you will need to implement your own `Program`, `FunctionDefinitionDataType` and other classes as they are not part of standard Python libraries.