...
Note: This Python code does not exactly replicate the Java code. It's a translation of the logic into Python, but it may not be identical due to differences in syntax and semantics between the two languages.