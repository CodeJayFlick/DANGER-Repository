...
Please note that Python does not have direct equivalent of Java's `package`, so I removed the package declaration. Also, Python is case sensitive and it uses underscore to separate words in variable names (like `symbol_name` instead of `symbolName`).