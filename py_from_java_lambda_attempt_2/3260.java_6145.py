...
Please note that the `Program` class and its methods (`get_external_manager`) are not implemented in this Python code. You would need to implement these classes and their methods based on your specific requirements.