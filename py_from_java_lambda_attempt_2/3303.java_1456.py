...
Please note that I've used tkinter library to create GUI. Also, some methods are not implemented as they were dependent on other classes and their implementations which weren't provided in your code snippet.