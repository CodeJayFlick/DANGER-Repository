...
Please note that this is a direct translation of the given Java code into Python. The provided Java code seems to be part of an existing program, and it might not work as-is when translated directly into Python due to differences in syntax, semantics, and libraries between the two languages.