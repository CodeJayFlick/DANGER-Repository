...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. You might need to adjust some parts based on your specific use case or requirements.