...
Please note that this is a direct translation of Java code into Python. The equivalent Python classes and methods are written as closely to their original counterparts in Java as possible.