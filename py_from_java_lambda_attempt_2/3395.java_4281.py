...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. The original Java code might have some specific requirements or constraints that are not easily translatable to Python.