...
Please note that Python does not support direct translation of Java code. It is necessary to manually translate the code into equivalent Python syntax and semantics.