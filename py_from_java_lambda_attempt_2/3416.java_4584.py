...
Please note that Python does not support Java's concept of static variables and methods. Also, the equivalent of `@Override` in Python is to define a method with the same name as the parent class' method.

Also, I used f-strings for formatting strings which are available from Python 3.6 onwards. If you're using an earlier version of Python, you can use regular string concatenation instead.