...
Please note that this code is not directly executable. It's a translation of the given Java code to Python and some parts might need further adjustments or additional context to work correctly in a Python environment.