...
Please note that this is a direct translation of the given Java code into equivalent Python code. However, some parts might not be directly translatable due to differences in syntax and semantics between Java and Python.