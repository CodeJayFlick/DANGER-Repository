...
```
Note that I've used the `tkinter` library for creating a GUI component (the toolbar icon), and the `PIL` library to resize the image. The rest of the code is straightforward translation from Java to Python.

Please note that this is not an exact equivalent of the original Java code, but rather a Python implementation with similar functionality.