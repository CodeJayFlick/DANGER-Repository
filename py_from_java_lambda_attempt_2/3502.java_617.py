...
Please note that this is a direct translation of the Java code into Python, and it may not be perfect. Some parts might need to be adjusted or modified based on your specific use case.