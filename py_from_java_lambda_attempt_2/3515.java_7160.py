...
Please note that this is not an exact translation of your original Java code. Python does not support static variables or methods, so I have removed those parts from the class definition.