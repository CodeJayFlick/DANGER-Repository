...
Please note that Python does not support Java's `@Before` and `@After` annotations, so the setup and teardown methods are defined directly in the class definition.