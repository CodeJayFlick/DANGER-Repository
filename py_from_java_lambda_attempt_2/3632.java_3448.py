...
Please note that this is a direct translation of the provided Java code into equivalent Python. The actual functionality may not be exactly the same due to differences in language syntax and semantics between Java and Python.