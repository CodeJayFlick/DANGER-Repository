...
Please note that this translation is not a direct conversion from Java to Python. The original code has been adapted and modified to fit the syntax and conventions of Python.