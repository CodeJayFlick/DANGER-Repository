...
```
Note that I've used the `pyghidra` library to translate the Java code to Python. This library provides a Python interface to the Ghidra reverse engineering framework.