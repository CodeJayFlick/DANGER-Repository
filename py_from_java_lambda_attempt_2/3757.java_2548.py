...
Please note that the translation is not a direct copy-paste of Java code to Python. The original Java code has been modified and simplified for better readability in Python.