...
Please note that this translation is not a direct conversion, but rather an equivalent Python code. Some Java-specific constructs like `package`, `import` statements and some type annotations were removed as they are not necessary in Python.