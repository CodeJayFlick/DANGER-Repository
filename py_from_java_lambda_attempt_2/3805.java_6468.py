...
Please note that Python does not support direct translation of Java's abstract classes and methods. The equivalent Python class `AbstractConvertAction` has been defined with abstract methods using the `@abstractmethod` decorator, which are intended to be implemented by any subclass.