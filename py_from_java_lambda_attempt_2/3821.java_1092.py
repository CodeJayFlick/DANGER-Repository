...
Please note that this translation does not cover all the functionalities of the original Java code. Some methods and properties are missing or have been simplified to their Python equivalents.