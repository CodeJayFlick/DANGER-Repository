...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation, as some concepts and structures in Java may have different equivalents or implementations in Python.