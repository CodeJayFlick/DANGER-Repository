...
Please note that this translation assumes the Java code provided has a one-to-one mapping with Python. However, some differences in syntax and semantics may exist between the two languages.