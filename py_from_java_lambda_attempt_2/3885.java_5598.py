...
This Python code defines the same classes and methods as the original Java code. Note that some parts of the code have been simplified or modified to fit better with Python's syntax and semantics, such as using `isinstance()` instead of type checking for objects.