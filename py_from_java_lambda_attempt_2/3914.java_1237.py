...
Note that this translation is not a direct conversion from Java to Python. It's more of an equivalent implementation in Python. The logic and functionality remain the same but may have slight differences due to language-specific features or nuances.