...
Note that I have used Python's property decorator (`@property`) and setter decorators (`@addr.setter`, etc.) to implement getter and setter methods for each attribute, which is similar to how you would do it with getters and setters in Java.