...
Please note that I have not implemented the `InstructionSearchUtils.get_whitespace` method as it was missing in your Java code. You would need to implement this based on your requirement.

Also, please ensure you have a Python equivalent of the following classes:
