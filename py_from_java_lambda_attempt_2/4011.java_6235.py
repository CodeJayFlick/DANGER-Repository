...
Please note that the `LabelMgrPlugin` and its methods (`remove_label_callback`, `is_on_external_reference`, etc.) are not implemented here, as we do not know their exact functionality.