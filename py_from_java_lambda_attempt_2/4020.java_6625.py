...
Please note that this is a translation of the Java code into Python. It may not be exactly equivalent due to differences in syntax and semantics between the two languages.