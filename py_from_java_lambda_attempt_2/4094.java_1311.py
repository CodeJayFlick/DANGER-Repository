...
Please note that this translation is not a direct conversion of Java code to Python. The provided Java code seems to be part of an IDE plugin for Ghidra, which is a reverse engineering framework. Therefore, some parts may need adjustments according to your specific use case and requirements.

Also, the `ResourceManager`, `KeyStroke`, `InstructionIterator`, `AddressSetView`, `Instruction`, `FunctionIterator`, and `Program` classes are not part of Python's standard library. They might be custom classes or interfaces defined in the original Java code. You would need to implement these classes according to your specific requirements.

Lastly, this translation assumes that you have a basic understanding of object-oriented programming (OOP) concepts like inheritance, polymorphism, and encapsulation.