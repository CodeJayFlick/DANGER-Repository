...
Please note that Python does not support exact equivalent of Java's `abstract` keyword. Instead, you can define an abstract class by defining a base class with all methods declared as `@abstractmethod`.