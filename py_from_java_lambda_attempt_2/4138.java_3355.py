...
This Python code is a direct translation of the Java code. It uses Tkinter for creating GUI components and handles button clicks using callback functions.