...
Please note that this is a translation, not an exact conversion. Python has different syntax and semantics than Java, so some changes were necessary to make the code work in Python.