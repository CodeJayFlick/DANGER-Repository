...
Please note that this is a translation of the Java code into Python. It may not be perfect and some parts might need to be adjusted or modified according to your specific needs.