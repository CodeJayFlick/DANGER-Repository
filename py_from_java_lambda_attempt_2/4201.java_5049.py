...
Please note that this is a direct translation of the Java code into Python. You may need to modify it according to your specific requirements and the libraries you are using in your project.

Also, please note that some parts of the original code (like `JPanel`, `GLabel`, etc.) might not be directly translatable into Python because they seem to be custom classes defined in Java.