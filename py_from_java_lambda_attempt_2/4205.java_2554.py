...
Note that this is a direct translation of the Java code into Python. However, it's worth noting that some parts may not work as expected in Python due to differences between the two languages (e.g., lack of `enum` types).