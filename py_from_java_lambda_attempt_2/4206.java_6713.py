...
Please note that the translation is not a direct copy-paste of Java code to Python. It's more like an interpretation and adaptation of the given code into Python syntax.