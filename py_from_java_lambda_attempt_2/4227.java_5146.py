...
Note that this is not a direct translation of Java to Python. Some parts may be missing or simplified due to the differences between languages and frameworks.