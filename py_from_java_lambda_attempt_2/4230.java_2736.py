...
Please note that Python does not support exact equivalent to Java's static method, hence I have removed all `static` methods. Also, Python is case sensitive and it doesn't allow direct access to private variables like in Java.