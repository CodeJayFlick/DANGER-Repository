...
Please note that this is a direct translation from Java to Python. It might not be perfect as it's hard to translate some parts directly without knowing more about the context in which they are used.