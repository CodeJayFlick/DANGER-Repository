...
Please note that this is a direct translation from Java to Python and may not be perfect. Some parts might need adjustments based on your specific use case or requirements.