*   {    getFilter()   * Filter;
    ...
    getFilter()
      *   * Filter;    getFilter();
       *  String name= getFilter();  *   * Filter;     getFilter();
    getFilter();
    ...
    *Filter()
    ...
    getFilter()
    getFilter()
    getFilter()  { return true; } // Only one filter is active
...
This simplified code still maintains the core functionality of the original code but is more concise and easier to read.