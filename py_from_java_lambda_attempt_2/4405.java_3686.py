...
Please note that this is a direct translation of the Java code into Python. The original code was written in Java, and some parts may not be directly translatable to Python due to differences between the two languages.