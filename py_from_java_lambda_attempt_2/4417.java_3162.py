...
Please note that Python does not have direct equivalent of Java's Swing library. The above code uses tkinter for creating GUI components and layout management.