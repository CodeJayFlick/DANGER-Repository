...
Please note that this is just one possible translation of the Java code into Python. The actual implementation may vary depending on specific requirements and constraints.