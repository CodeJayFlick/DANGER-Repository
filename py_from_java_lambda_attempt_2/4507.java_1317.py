...
Note that this translation is not a direct conversion from Java to Python, but rather an implementation of the same functionality using Python. The `@abstractmethod` decorator in Python does not exist as such, so I have used regular abstract methods instead.