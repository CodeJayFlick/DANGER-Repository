...
Please note that Python does not have direct equivalent of Java's Swing library. Tkinter is a built-in Python library for creating GUIs, which I used in the translation.