...
Note: The above Python code is not exactly equivalent to the Java code. It's a translation of the Java code into Python, but it may not work as expected without further modifications and testing.