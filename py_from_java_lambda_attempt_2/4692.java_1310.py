...
Please note that Python does not support the exact equivalent of Java's `private` keyword. In this translation, I have used lowercase letters for variable names to indicate they are instance variables (i.e., attributes).