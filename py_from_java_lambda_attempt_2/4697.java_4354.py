...
Note that I used Python's built-in dictionary type (`dict`) to represent the `Map` in Java, and Python's built-in string formatting capabilities (the `f-string` syntax) for the `__str__` method.