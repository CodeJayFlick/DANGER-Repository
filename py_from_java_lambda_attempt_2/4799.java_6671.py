...
Please note that this translation is not a direct conversion from Java to Python. The code has been rewritten in Python style and might have some differences due to the nature of both languages.