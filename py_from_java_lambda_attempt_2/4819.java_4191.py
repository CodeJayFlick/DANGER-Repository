...
Note that I have not implemented all methods in these classes as they were present in the original Java code. You would need to modify them according to your specific requirements and implementation details.