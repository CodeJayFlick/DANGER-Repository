...
Please note that Python does not have direct equivalent of Java's `BinaryReader`, `ResourceMap` and other classes. I've replaced them with similar constructs in the above code.