...
Please note that you need to implement `FactoryBundledWithBinaryReader` class and its methods (`get_pointer_index`, `read_next_byte`, `read_next_ascii_string`) according to your specific binary file format.