...
Please note that Python does not have direct equivalent of Java's `short` type. In this translation, I used integers to represent the values originally stored in short variables.