...
Please note that I have translated the Java classes `ResourceType` and `ResourceName`, but their methods are not implemented as they were missing from the provided Java code.