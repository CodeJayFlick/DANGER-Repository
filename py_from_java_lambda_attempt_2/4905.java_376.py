...
Please note that the `read_next_byte`, `read_next_short` and similar methods are not defined in this code. They should be implemented based on your specific binary reader class.