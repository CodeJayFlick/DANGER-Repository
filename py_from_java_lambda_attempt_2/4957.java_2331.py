...
Please note that the above Python code is a direct translation of your Java code. However, it does not include any actual implementation of the functions `read_record_header`, `get_record_length`, `has_big_fields`, `omf_read_index`, and `omf_read_int2_or_4`. These functions should be implemented based on how you want to read OMF records in Python.