...
Note: This Python code does not include the Java classes `CliAbstractSig`, `CliBlob`, `BinaryReader`, and others. It only includes the methods from your provided Java class translated into Python.