...
Please note that Python does not have direct equivalents for some Java features like `CompletableFuture`, `Icon` and `TaskMonitor`. I've replaced them with equivalent constructs in Python.