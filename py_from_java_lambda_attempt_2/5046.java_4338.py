...
Note: The `CliTypeTable`, `CliStreamMetadata`, and `CliCodedIndexUtils` classes are not defined in this code. They would need to be implemented separately or imported from another module.