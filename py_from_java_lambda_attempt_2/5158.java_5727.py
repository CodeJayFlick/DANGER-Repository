...
Please note that Python does not have direct equivalent of Java's `Map` class. The above code uses a dictionary (`dict`) as the representation of a map in Python.