...
Note: The Python code does not exactly replicate the Java code. It is a translation of the given Java code into Python and may require adjustments based on your specific requirements.