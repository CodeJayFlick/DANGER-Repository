...
Note that Python does not have direct equivalents of Java's abstract classes and methods. Instead, we use the `pass` statement to indicate where an implementation is required in subclasses.