Here is a direct translation of the Java class into equivalent Python:
...
Please note that Python does not support direct equivalent of Java's `public final static` access modifiers.