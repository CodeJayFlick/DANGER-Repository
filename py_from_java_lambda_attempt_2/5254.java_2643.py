...
Please note that this Python code is a direct translation of the given Java code. It might not be perfect, as some parts may need adjustments based on your specific use case and requirements.