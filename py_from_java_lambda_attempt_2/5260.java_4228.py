...
Please note that Python does not have direct equivalent of Java's `static` keyword. In this translation, I used the class itself as a namespace for static variables and methods.