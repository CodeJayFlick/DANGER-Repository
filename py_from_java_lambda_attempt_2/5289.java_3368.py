...
Please note that Python does not have direct equivalent of Java's StringBuilder class, so I used the built-in str type to mimic its functionality. Also, some methods like `apply_demangled_name` and `StringUtilities.is_displayable` are not defined in this code as they were part of your original Java code.