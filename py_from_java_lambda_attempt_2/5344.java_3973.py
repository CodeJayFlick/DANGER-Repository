...
Please note that Python does not have a direct equivalent of Java's `package` declaration. Also, the `Color` class in Java is used to represent colors with RGB values. In Python, we can use tuples to achieve this functionality.