...
Note: This is a translation from the given code. It may or may not be exactly what you want as it depends on how you are using this in your actual program.