...
Please note that Python does not have direct equivalent of Java's HashMap and ArrayList. We are using defaultdict from collections module to simulate the behavior of a hashmap in this code.