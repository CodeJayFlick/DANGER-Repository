...
Please note that this is a direct translation of the Java code into Python. The functionality and logic remain the same, but you may need to adjust some parts based on your specific use case or requirements in Python.