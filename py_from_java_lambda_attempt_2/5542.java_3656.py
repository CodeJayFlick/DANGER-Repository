...
Please note that Python does not have direct equivalent of Java's `DockingAction`, `MenuData` and other classes. The above code is a simple translation of the provided Java code into Python.