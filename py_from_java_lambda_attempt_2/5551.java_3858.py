...
Note that Python does not have direct equivalent of Java's `Map` and `HashMap`. Instead, we use a dictionary (`dict`) which is similar to a map. Also, Python doesn't require explicit type definitions for variables or method parameters like Java does.