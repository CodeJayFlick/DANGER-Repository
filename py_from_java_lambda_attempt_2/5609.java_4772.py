...
Please note that Python does not have direct equivalent of Java's `package` statement. Also, the concept of interfaces in Python is different from those in Java. In this translation, I've used abstract base classes (`ABC`) to define an interface-like behavior.