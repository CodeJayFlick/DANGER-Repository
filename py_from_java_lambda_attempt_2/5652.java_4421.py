...
Note that Python does not have direct equivalents to Java's annotations, so I've implemented the equivalent functionality using properties and setter methods.