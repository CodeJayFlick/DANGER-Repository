...
Note that this is a direct translation of the Java code into Python. The equivalent Python classes and methods are used to maintain compatibility with the original Java code.