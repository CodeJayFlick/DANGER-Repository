...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, the translation is based on my understanding and may require adjustments according to your specific requirements.