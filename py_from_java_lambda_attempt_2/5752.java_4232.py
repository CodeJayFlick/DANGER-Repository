...
Note: This is a direct translation from Java to Python. The code may not be perfect and might require some adjustments based on the specific requirements of your project.