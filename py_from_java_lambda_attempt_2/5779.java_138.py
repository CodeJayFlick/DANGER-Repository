...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, in Python, method overriding is done by providing the same method name and parameters as the parent class.