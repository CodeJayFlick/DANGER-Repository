...
Note: This is a direct translation of the Java code into Python. The original code was written in Java, and this translation maintains its structure and functionality as closely as possible while still being idiomatic to Python.