...
Note: The `ProgramMemoryComparator` class in Python does not have a direct equivalent to the Java code. I've translated it into a simpler form that still achieves the same functionality, but with some simplifications.