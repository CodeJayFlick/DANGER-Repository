...
Please note that this is a direct translation and may not work as-is. You would need to implement the `_invokeHR` method, which seems to be responsible for calling native functions with the given parameters.