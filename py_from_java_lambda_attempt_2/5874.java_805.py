...
Please note that the above Python code is not exactly equivalent to the Java code. It's a translation of the provided Java code into Python and might require some adjustments according to your specific needs.