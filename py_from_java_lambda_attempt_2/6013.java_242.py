...
Please note that the above Python code is not a direct translation of your Java code. It's more like an adaptation to fit into Python syntax and structure.