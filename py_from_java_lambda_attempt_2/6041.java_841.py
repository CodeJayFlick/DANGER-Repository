...
Please note that the `CompareFunctionsTestUtility` class is not provided in this translation. It seems to be a utility class used for testing purposes and its implementation would depend on your specific requirements.