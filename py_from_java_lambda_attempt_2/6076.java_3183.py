...
Please note that the translation from Java to Python may not be exact in terms of syntax and semantics. The code above is a best-effort attempt at translating the given Java code into equivalent Python.