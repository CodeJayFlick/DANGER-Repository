...
Please note that this is a direct translation of the given Java code into Python. The functionality and logic remain the same but some minor adjustments were made to fit it in Python syntax.