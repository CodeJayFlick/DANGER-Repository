...
Note: The above Python code is not exactly the same as the Java code. It's a translation of the Java code into Python and it may require some modifications to work correctly in your specific environment.