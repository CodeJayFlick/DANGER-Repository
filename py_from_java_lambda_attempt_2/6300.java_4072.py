...
Please note that this is a direct translation of the Java code into Python. The original code might have some issues or limitations in terms of compatibility with Python syntax and semantics.