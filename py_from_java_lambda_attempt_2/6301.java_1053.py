...
Note that this is a direct translation of the Java code into Python. The original Java code uses various libraries and frameworks (e.g., JUnit, Swing) which are not directly equivalent in Python.