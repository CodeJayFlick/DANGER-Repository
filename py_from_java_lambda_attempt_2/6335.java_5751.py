...
Note: This code is not a direct translation of the Java code. It's more like an adaptation to Python, as some parts may have been modified or removed due to differences in syntax and functionality between languages.