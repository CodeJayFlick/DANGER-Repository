...
Please note that this translation may not be perfect as Python and Java have different syntax and semantics. Some parts of the code might need to be adjusted or rewritten for it to work correctly in a Python environment.