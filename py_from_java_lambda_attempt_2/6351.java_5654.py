...
Please note that this is a direct translation of Java code into Python. It might not be perfect and may require some adjustments based on your specific use case.