...
Note: This Python code is not fully functional as it requires the `ghidra_app_plugin_core_function` module which seems to be specific to the Java-based Ghidra application.