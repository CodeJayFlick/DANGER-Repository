...
Please note that this is a direct translation of your Java code into Python. However, some parts might not work correctly or need adjustments according to how you are using them in your actual application.