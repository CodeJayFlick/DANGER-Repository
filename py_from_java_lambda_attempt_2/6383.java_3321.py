...
```
Note that I've used the `unittest` module to define a test case, and the `run_swing` function is not defined in this code snippet. You would need to implement it separately.

Also, some parts of the original Java code are missing or simplified for brevity (e.g., error handling, logging).