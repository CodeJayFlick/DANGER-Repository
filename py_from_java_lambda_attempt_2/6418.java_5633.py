...
Note: The above Python code is just a translation of Java code into Python. It may require some modifications to work correctly as it's missing many details like imports, class definitions etc.