...
This Python code does not exactly replicate the Java code. It is a simplified version of it and may need further modifications to match your exact requirements.