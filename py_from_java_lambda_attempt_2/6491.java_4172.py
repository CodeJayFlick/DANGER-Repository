...
Note: This Python code assumes that the `CommentUtils` class has a method called `get_comment_annotations()` which takes a string as input and returns a list of annotations.