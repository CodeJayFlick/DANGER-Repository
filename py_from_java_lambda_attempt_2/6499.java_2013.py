...
This Python code is a direct translation of the given Java code. It uses the `unittest` module for unit testing and does not include any GUI components, as they are specific to the Java Swing framework used in the original code.