...
if __name__ == '__main__':
    unittest.main()
```
Note that I've replaced the Java-specific constructs (e.g. `@Test`, `public` methods) with Python's equivalent syntax (e.g. method definitions, indentation). I've also removed the license information and comments from the original code to keep this translation concise.