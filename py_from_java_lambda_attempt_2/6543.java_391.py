...
Note: This Python code is a direct translation of the given Java code. It does not include any error handling or exception checking, which may be necessary depending on how you plan to use this code in your application.