...
Note: This Python code does not exactly translate the given Java code. It is more of a representation in Python and may require some modifications to work correctly as per your requirements.