...
Note: The above Python code is a direct translation of the Java code provided. It does not include any error handling or exception checking that might be necessary in a production environment.