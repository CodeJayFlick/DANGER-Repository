...
Please note that Python does not have direct equivalent of Java's `Preferences` class. You may need to implement your own preference storage mechanism in Python, depending on how you want to store and retrieve the preferences.

Also, this code uses Tkinter for creating a GUI window. If you prefer using another library or framework (like PyQt), please let me know.