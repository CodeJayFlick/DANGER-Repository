...
This Python code is equivalent to the Java code you provided. Note that I've used Tkinter, a built-in Python library, to create GUI components like buttons and labels.