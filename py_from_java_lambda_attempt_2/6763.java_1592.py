...
Please note that this is a direct translation of the Java code into Python. It might not be perfect and could use some improvements, but it should work as expected.