...
Please note that this translation is not a direct conversion from Java to Python, but rather an equivalent implementation in Python. The code may look different due to the differences between the two languages and their respective syntaxes.