...
Note that I used Python's type hinting feature to indicate the types of variables and function parameters. This is not enforced at runtime, but it can be useful for documentation purposes or with tools like mypy.