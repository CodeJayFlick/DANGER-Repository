...
Note that Python does not have direct equivalent of Java's `@Override` annotation. The method is simply declared with the same name as its parent class' s method.