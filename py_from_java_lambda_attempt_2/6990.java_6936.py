...
Note that this is a direct translation of the Java code into Python, and it may not be perfect. For example, some methods like `readString` are missing in this translation because they were not present in your original Java code.