...
Please note that this translation is not perfect. The Java code seems to be part of a larger program, so some parts might need additional context or implementation in Python.