...
Please note that Python does not have a direct equivalent to Java's `final` keyword. The class itself is final, but the methods inside it are not (they can be overridden in subclasses).