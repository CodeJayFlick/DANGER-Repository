...
Note that Python does not have a direct equivalent to Java's `Comparable` interface. Instead, you can define the comparison methods (`__lt__`, in this case) manually.