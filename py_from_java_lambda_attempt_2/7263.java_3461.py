...
Note that this translation is not a direct copy-paste from Java to Python. It's an interpretation of the code in terms of Python syntax and semantics.

Also note that some parts of the original code have been omitted or modified for simplicity and readability purposes.