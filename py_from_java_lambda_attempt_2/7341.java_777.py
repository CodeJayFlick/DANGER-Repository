...
Please note that this is a direct translation of the Java code into Python. The resulting Python code may not be optimal or idiomatic for Python programming.