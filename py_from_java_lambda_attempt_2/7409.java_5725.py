...
Please note that this is a direct translation of the given Java code into Python, and it may not be perfect. The `read_next_byte`, `read_next_int_le`, `read_next_short_le` methods are used to read data from a binary reader in little-endian format.