...
Please note that Python doesn't have a direct equivalent to Java's `MemoryAccessException`. Instead, we catch the general exception type (`Exception`) and do nothing with it.