...
Please note that the `BinaryReader` class is not implemented in this code, as it seems to be a custom class. Also, I have used Python's built-in properties for getter methods and did not implement setter methods.