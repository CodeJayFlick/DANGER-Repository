...
Please note that Python doesn't support direct translation of Java code. The above code is a manual translation and may not be exactly the same as the original Java code.