...
Please note that the Python code is not a direct translation of Java to Python. It's more like an adaptation where some concepts and libraries might be different in Python compared to Java.