...
Please note that this translation does not include the `is_scaled_past_vertex_painting_threshold` and `paint_scaled_vertex` methods as they are missing in your Java code.