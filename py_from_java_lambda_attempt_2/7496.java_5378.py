...
Please note that this is a direct translation of the given Java code into equivalent Python, without considering any specific requirements or functionality.