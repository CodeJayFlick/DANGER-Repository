...
Note: The code above is not a direct translation of the Java code. It's more like an equivalent Python implementation with some differences in syntax and semantics due to the nature of the two languages.