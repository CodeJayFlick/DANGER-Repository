...
This Python code is a direct translation of the Java interface. Note that some parts like `@Override`, type hints and comments are not directly translatable to Python as they have different syntax or functionality in each language.