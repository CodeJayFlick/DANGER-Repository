...
Note that the Python code does not have direct equivalent of Java's JUnit and Mockito. The test cases are written using Python's built-in `unittest` module.