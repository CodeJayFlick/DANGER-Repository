...
Note that this translation assumes a `NameVersions` class with a static method `generate()` to handle the generation of name versions. The implementation of this method is left out as it depends on the specific requirements and logic for your application.