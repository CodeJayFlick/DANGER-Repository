...
Note that this translation assumes you have the necessary Python libraries and modules installed to run the code, including `ghidra_app`, which may require additional setup or configuration depending on your environment.