...
Note that this translation is not a direct conversion, but rather an equivalent Python code. Some Java-specific constructs like `@Override`, `protected` and `public` are omitted as they do not have direct equivalents in Python.