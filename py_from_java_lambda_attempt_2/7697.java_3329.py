...
Please note that Python does not have a built-in equivalent to Java's `Color` class. Instead, we use tuples of three integers representing RGB values and convert them back into colors as needed.