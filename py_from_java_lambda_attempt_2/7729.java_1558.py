...
Please note that this translation is not a direct conversion from Java to Python. The original code was written in such a way that it's hard to translate directly into Python without losing the meaning of the code.