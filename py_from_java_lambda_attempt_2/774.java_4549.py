...
Please note that the Python code is a direct translation of the Java interface and does not include any implementation. The methods in this class are abstract, meaning they must be implemented by subclasses.