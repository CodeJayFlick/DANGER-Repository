...
Note that the Python code is not a direct translation of the Java code. Instead, it's an attempt to recreate the same functionality in Python using equivalent data structures and algorithms.