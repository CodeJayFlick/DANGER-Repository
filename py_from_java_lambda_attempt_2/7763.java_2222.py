...
Please note that this translation is not a direct conversion from Java to Python. It's more of an interpretation, as some parts might have been simplified or re-written for better understanding in Python.