...
Please note that Python does not support static imports like `import static ghidra.app.util.datatype.microsoft.MSDataTypeUtils.*;`. You would need to import each class or function individually.