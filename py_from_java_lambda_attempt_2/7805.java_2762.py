...
Please note that this is a direct translation of the given Java code into Python. The original code seems to be part of an IDE plugin for Ghidra and uses various classes and methods specific to Ghidra. Therefore, you may need additional imports or modifications depending on your use case.