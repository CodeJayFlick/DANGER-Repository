...
Please note that Python does not have direct equivalent of Java's `@Override` annotation. Also, the exception handling mechanism in Python is different from Java.