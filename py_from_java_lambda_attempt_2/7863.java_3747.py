...
Please note that Python does not have direct equivalent of Java's `switch` statement. Instead, we use a dictionary to map the characters to their corresponding conventions.