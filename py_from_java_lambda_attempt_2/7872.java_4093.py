...
Note: Python does not have direct equivalent of Java's StringBuilder, HashMap and other classes. So I used built-in python functions like `str` for string operations, list for storing unique fragments and dictionary to store the mapping between fragment names and their genericized versions.