...
Please note that the Python code does not exactly replicate the Java code. The logic of parsing and inserting names is different in both languages. This translation aims to preserve the structure and functionality of the original Java code, but it may require adjustments based on specific requirements or constraints.