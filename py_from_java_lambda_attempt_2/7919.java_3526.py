...
Note that Python does not have direct equivalents for Java's `enum` and `switch-case`, so the code has been rewritten to use class constants and simple conditionals instead.