...
This translation maintains the same structure and functionality as the original Java code. However, it's important to note that some parts of the code may require additional modifications or changes depending on how you choose to implement them in Python.