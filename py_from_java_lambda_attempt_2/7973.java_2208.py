...
Please note that this is a direct translation of the given Java code into Python. It may not be perfect and might require some adjustments to work correctly in your specific use case, as it's missing actual implementations for many methods (marked with `# implementation`).