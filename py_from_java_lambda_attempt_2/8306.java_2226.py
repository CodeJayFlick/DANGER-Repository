...
Please note that Python does not have direct equivalent of Java's `enum` type. Instead, we use the built-in `Enum` class from the `enum` module to achieve similar functionality.