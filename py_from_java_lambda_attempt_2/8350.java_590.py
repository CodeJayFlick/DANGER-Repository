...
Please note that Python does not have direct equivalent of Java's `BigInteger` class. You can use the built-in integer type (`int`) or a library like `gmpy2` if you need arbitrary-precision arithmetic.