...
Please note that this is a direct translation of Java code into Python. You may need to adjust it according to your specific requirements and implementation details in Python.