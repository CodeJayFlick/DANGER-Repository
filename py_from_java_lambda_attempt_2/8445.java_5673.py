...
Please note that this Python code does not exactly translate the given Java code. It is a simplified version of it, and some parts might be missing or different from their original counterparts in the Java code.