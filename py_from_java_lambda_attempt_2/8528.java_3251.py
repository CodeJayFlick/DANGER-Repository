...
Please note that I have translated the Java code into Python as closely as possible. However, some parts of the original code might not work exactly as expected because they are specific to Java and may require modifications for a Python environment.