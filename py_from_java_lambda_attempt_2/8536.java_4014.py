...
Please note that the Python code does not exactly match the Java code. It's a translation, but it might need some adjustments to work correctly in your specific use case.