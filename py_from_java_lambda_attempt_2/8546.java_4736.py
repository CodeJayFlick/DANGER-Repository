...
Please note that the `ExtraFrameAndProcedureInformationMsSymbol` and `FunctionSymbolApplier` classes are incomplete in this translation, because they were not fully implemented in the original Java code.