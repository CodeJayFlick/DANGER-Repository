...
Please note that Python does not have direct equivalent to Java's `private` keyword. In Python, you can use underscore prefix (`_`) to indicate internal or private variables and functions.