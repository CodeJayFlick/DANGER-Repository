...
Note that this translation is not a direct conversion from Java to Python, but rather an interpretation of how you might implement the same logic in Python. The specific details may vary depending on your exact requirements and constraints.