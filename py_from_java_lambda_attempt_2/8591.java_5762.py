...
Please note that Python does not have direct equivalent of Java's `package`, so I did not include any package declaration. Also, the translation assumes that you are using a framework or library similar to what was used in your original code (e.g., `Program` and its methods).