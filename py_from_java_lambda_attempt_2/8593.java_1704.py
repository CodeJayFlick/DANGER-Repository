...
Please note that Python does not support Java's `@PluginInfo` annotation or other similar constructs directly. The equivalent functionality would be achieved through the use of Python decorators and annotations.