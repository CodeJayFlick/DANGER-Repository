...
Note that Python does not have direct equivalent of Java's `@Override` annotation. Also, in the above code, I used property decorator (`@property`) to create a getter for the `symbol_server` attribute.