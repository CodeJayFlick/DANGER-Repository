...
Note: The `runSwing` and `waitForSwing` methods are not implemented in Python as they seem to be related to the Swing library which is a Java-specific GUI toolkit.