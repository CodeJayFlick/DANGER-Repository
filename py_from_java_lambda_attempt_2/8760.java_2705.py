...
Please note that this is a direct translation of the Java code to Python, and it may not be exactly equivalent. For example, some methods like `doCreateCorrelator` are directly translated as they were in the original Java code.