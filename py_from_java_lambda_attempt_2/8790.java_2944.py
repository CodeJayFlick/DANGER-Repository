...
Please note that the above Python code is a direct translation of your Java code. It might not be perfect, as some parts may need to be adjusted according to Python's syntax and conventions.