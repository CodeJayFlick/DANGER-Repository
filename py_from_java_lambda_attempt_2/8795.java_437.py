...
Note that Python does not have direct equivalent of Java's `package`, so I removed it. Also, Python has no concept of checked exceptions like Java, so the exception handling is different in this translation.