Here is the translation of the Java interface `VTMarkupItem` into a Python class:
...
Please note that the `canApply`, `apply`, and other methods are marked as `NotImplementedError` because they need to be implemented in a subclass.