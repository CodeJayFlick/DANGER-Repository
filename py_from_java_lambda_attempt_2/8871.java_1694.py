...
Please note that you need to implement methods like `is_source_cursor_on_screen`, `get_source_function`, `is_destination_cursor_on_screen`, `get_destination_function` and `get_match` in your Python code.