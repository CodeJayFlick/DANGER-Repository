...
Note that this translation is not a direct equivalent of the Java code. Python does not support some features like static variables or anonymous classes used in the original code. Also, some parts of the code are missing (like loading images) and will need to be implemented separately.

This translation assumes you have `JPanel`, `MatchTagComboBox` and other classes defined elsewhere in your project.