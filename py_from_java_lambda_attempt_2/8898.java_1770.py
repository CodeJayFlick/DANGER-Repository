...
Please note that this translation assumes you have the following classes and methods:

- `VTController`: has methods `get_tool()` and `parent_component()`.
- `TagEditorDialog`: a class with an initializer (`__init__`) and a method `show_dialog()`.