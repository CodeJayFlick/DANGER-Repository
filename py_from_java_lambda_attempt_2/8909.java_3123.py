...
Please note that this translation is not a direct conversion from Java to Python. Some parts of the code may need adjustments based on how you choose to structure your Python program.