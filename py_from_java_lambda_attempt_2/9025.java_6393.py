...
```
Note that I've omitted some of the Java-specific code, such as the `TableColumnDescriptor` and `Comparator` implementations. In Python, we can use dictionaries or lists to represent tables and columns, respectively.

Also, I've assumed that the `VTController`, `Session`, and other classes are defined elsewhere in your project. If you need help with those parts of the code, please let me know!