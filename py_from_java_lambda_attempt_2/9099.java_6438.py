...
Note that the translation is not a direct conversion from Java to Python. The code has been adapted and modified to fit into the Python syntax and style.