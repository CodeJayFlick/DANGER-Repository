...
Please note that this is a direct translation of the given Java code into Python. It might not be perfect as it's hard to directly translate some parts (like `DataTypeManagerDB`, `ProgramDB` etc.) without knowing their exact implementations in Python.