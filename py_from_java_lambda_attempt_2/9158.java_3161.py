...
Please note that this is a direct translation of the given Java code into Python. The actual implementation might require additional work to make it functional in Python.