...
Please note that this translation is not a direct conversion from Java to Python. The `UnsupportedOperationException` in Java does not have an exact equivalent in Python, so I used the built-in exception mechanism of Python instead.