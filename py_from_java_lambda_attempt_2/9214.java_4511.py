Here is the translation of the Java interface `FieldKeyRecordNode` into a Python class:
...
This Python class is equivalent to the Java interface `FieldKeyRecordNode`. The methods in this class are abstract (i.e., they do not have any implementation), so you would need to implement them according to your specific requirements.