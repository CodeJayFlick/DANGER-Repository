...
Please note that the translation is not a direct conversion from Java to Python. The original code has been modified and simplified for better readability in Python.