...
- Renamed `ActionToGuiMapper` constructor to take no arguments (since Java's constructor is equivalent to Python's `__init__` method).
- Replaced Java's static methods with regular instance methods.
- Changed type hints for variables and function parameters according to their types in the original code.