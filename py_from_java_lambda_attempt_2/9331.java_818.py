...
Note that I had to create a `JButton` class in Python as there is no direct equivalent. Also, the code assumes that you have some sort of GUI framework set up (like Tkinter or PyQt), which is not included here for brevity's sake.