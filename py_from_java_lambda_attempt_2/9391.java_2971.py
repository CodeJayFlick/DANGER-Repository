...
Please note that this is a direct translation of the Java code into Python. The actual functionality might not work as expected without proper testing and adjustments for differences in how Python handles certain things compared to Java.