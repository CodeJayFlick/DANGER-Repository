...
Please note that Python does not have direct equivalent of Java's StringBuilder class. It uses the '+' operator to concatenate strings, which is less efficient than using a StringBuilder in Java.