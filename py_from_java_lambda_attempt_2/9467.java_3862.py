...
Please note that this is a direct translation of Java code into Python. The actual implementation may vary based on your specific requirements and mechanisms used in your project.