...
Note that I've used Python's built-in `property` decorator to create getter and setter methods for the attributes, which is equivalent to Java's getters and setters.