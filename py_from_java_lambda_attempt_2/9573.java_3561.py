...
Please note that Python does not have a direct equivalent to Java's `BigInteger` class. In this translation, I used the built-in integer type (`int`) for simplicity and assuming it is sufficient for your use case.