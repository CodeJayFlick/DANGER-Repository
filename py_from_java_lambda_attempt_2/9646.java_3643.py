...
Note that I've used Python's `re` module for regular expressions, and the `^` character to specify start-of-string matching. The `f"..."` string formatting is a new feature in Python 3.6+. If you're using an earlier version of Python, you can use the old-style formatting with `%`.