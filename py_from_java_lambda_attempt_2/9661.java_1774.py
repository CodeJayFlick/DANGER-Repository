...
Please note that the Python code is not a direct translation of Java. It's more like an equivalent implementation in Python with some adjustments to fit Python syntax and semantics.