Here is the translation of the Java interface `IndexedScrollable` to a Python class:
...
Note that I've used Python's `raise` statement to indicate which methods are abstract and must be implemented by any subclass.