...
Please note that this is a direct translation of the Java code into Python. The equivalent Python classes and methods are used to achieve similar functionality as in the original Java code.