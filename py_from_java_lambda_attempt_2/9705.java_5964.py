...
Please note that the Python code is not a direct translation of Java to Python. It's more like an adaptation, as some concepts and syntax are different between these two languages.