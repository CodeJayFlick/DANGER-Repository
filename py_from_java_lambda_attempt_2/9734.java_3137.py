...
This Python code does not exactly translate the given Java code. It's a simplified version of it and is intended to provide an equivalent functionality.