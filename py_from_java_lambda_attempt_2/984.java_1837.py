...
Please note that Python does not have direct equivalent of Java's `Map` or `ImmutableMap`. The code uses a dictionary (`WeakValueHashMap`) to simulate the behavior. Also, some parts like lazy weak cache logic and try preferred interfaces are left unimplemented in this translation because they require specific implementation based on your requirements.