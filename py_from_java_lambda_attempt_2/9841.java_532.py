...
Please note that Python does not have direct equivalent of Java's generics. So I've used type hints to indicate the types of variables and function parameters.