...
Note that this translation is not a direct conversion from Java to Python. The equivalent Python code may look different due to the differences in syntax and semantics between the two languages.