...
This Python code is a direct translation of the Java code. Note that some parts like `Component` and `Runnable` are not directly translated as they do not have exact equivalents in Python.