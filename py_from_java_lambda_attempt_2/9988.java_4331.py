...
Please note that the Python code is written in a way to mimic the Java code as closely as possible. However, there are some differences between the two languages and their respective standard libraries.